...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[3] = new SDataSignalAccess( top.raw_data_payload_fragment );
      signalAccess[4] = new CDataSignalAccess( top.filtered_data_valid );
      signalAccess[5] = new CDataSignalAccess( top.filtered_data_payload_last );
      signalAccess[6] = new IDataSignalAccess( top.filtered_data_payload_fragment );
      signalAccess[7] = new CDataSignalAccess( top.train_en );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/LMSFilter/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/LMSFilter/") + name + ".dat").c_str());
      #endif
    }
