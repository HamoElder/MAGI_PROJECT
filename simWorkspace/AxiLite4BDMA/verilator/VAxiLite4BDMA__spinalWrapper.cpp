...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[19] = new CDataSignalAccess( top.axi4S2M_arvalid );
      signalAccess[20] = new CDataSignalAccess( top.axi4S2M_arready );
      signalAccess[21] = new IDataSignalAccess( top.axi4S2M_araddr );
      signalAccess[22] = new CDataSignalAccess( top.axi4S2M_arid );
      signalAccess[23] = new CDataSignalAccess( top.axi4S2M_arlen );
      signalAccess[24] = new CDataSignalAccess( top.axi4S2M_arsize );
      signalAccess[25] = new CDataSignalAccess( top.axi4S2M_arburst );
      signalAccess[26] = new CDataSignalAccess( top.axi4S2M_awvalid );
      signalAccess[27] = new CDataSignalAccess( top.axi4S2M_awready );
      signalAccess[28] = new IDataSignalAccess( top.axi4S2M_awaddr );
      signalAccess[29] = new CDataSignalAccess( top.axi4S2M_awid );
      signalAccess[30] = new CDataSignalAccess( top.axi4S2M_awlen );
      signalAccess[31] = new CDataSignalAccess( top.axi4S2M_awsize );
      signalAccess[32] = new CDataSignalAccess( top.axi4S2M_awburst );
      signalAccess[33] = new CDataSignalAccess( top.axi4S2M_wvalid );
      signalAccess[34] = new CDataSignalAccess( top.axi4S2M_wready );
      signalAccess[35] = new IDataSignalAccess( top.axi4S2M_wdata );
      signalAccess[36] = new CDataSignalAccess( top.axi4S2M_wstrb );
      signalAccess[37] = new CDataSignalAccess( top.axi4S2M_wlast );
      signalAccess[38] = new CDataSignalAccess( top.axi4S2M_rvalid );
      signalAccess[39] = new CDataSignalAccess( top.axi4S2M_rready );
      signalAccess[40] = new IDataSignalAccess( top.axi4S2M_rdata );
      signalAccess[41] = new CDataSignalAccess( top.axi4S2M_rid );
      signalAccess[42] = new CDataSignalAccess( top.axi4S2M_rresp );
      signalAccess[43] = new CDataSignalAccess( top.axi4S2M_rlast );
      signalAccess[44] = new CDataSignalAccess( top.axi4S2M_bvalid );
      signalAccess[45] = new CDataSignalAccess( top.axi4S2M_bready );
      signalAccess[46] = new CDataSignalAccess( top.axi4S2M_bid );
      signalAccess[47] = new CDataSignalAccess( top.axi4S2M_bresp );
      signalAccess[48] = new CDataSignalAccess( top.axi4M2S_arvalid );
      signalAccess[49] = new CDataSignalAccess( top.axi4M2S_arready );
      signalAccess[50] = new IDataSignalAccess( top.axi4M2S_araddr );
      signalAccess[51] = new CDataSignalAccess( top.axi4M2S_arid );
      signalAccess[52] = new CDataSignalAccess( top.axi4M2S_arlen );
      signalAccess[53] = new CDataSignalAccess( top.axi4M2S_arsize );
      signalAccess[54] = new CDataSignalAccess( top.axi4M2S_arburst );
      signalAccess[55] = new CDataSignalAccess( top.axi4M2S_awvalid );
      signalAccess[56] = new CDataSignalAccess( top.axi4M2S_awready );
      signalAccess[57] = new IDataSignalAccess( top.axi4M2S_awaddr );
      signalAccess[58] = new CDataSignalAccess( top.axi4M2S_awid );
      signalAccess[59] = new CDataSignalAccess( top.axi4M2S_awlen );
      signalAccess[60] = new CDataSignalAccess( top.axi4M2S_awsize );
      signalAccess[61] = new CDataSignalAccess( top.axi4M2S_awburst );
      signalAccess[62] = new CDataSignalAccess( top.axi4M2S_wvalid );
      signalAccess[63] = new CDataSignalAccess( top.axi4M2S_wready );
      signalAccess[64] = new IDataSignalAccess( top.axi4M2S_wdata );
      signalAccess[65] = new CDataSignalAccess( top.axi4M2S_wstrb );
      signalAccess[66] = new CDataSignalAccess( top.axi4M2S_wlast );
      signalAccess[67] = new CDataSignalAccess( top.axi4M2S_rvalid );
      signalAccess[68] = new CDataSignalAccess( top.axi4M2S_rready );
      signalAccess[69] = new IDataSignalAccess( top.axi4M2S_rdata );
      signalAccess[70] = new CDataSignalAccess( top.axi4M2S_rid );
      signalAccess[71] = new CDataSignalAccess( top.axi4M2S_rresp );
      signalAccess[72] = new CDataSignalAccess( top.axi4M2S_rlast );
      signalAccess[73] = new CDataSignalAccess( top.axi4M2S_bvalid );
      signalAccess[74] = new CDataSignalAccess( top.axi4M2S_bready );
      signalAccess[75] = new CDataSignalAccess( top.axi4M2S_bid );
      signalAccess[76] = new CDataSignalAccess( top.axi4M2S_bresp );
      signalAccess[77] = new CDataSignalAccess( top.dataS2M_tvalid );
      signalAccess[78] = new CDataSignalAccess( top.dataS2M_tready );
      signalAccess[79] = new IDataSignalAccess( top.dataS2M_tdata );
      signalAccess[80] = new CDataSignalAccess( top.dataS2M_tid );
      signalAccess[81] = new CDataSignalAccess( top.dataS2M_tstrb );
      signalAccess[82] = new CDataSignalAccess( top.dataS2M_tkeep );
      signalAccess[83] = new CDataSignalAccess( top.dataS2M_tlast );
      signalAccess[84] = new CDataSignalAccess( top.dataM2S_tvalid );
      signalAccess[85] = new CDataSignalAccess( top.dataM2S_tready );
      signalAccess[86] = new IDataSignalAccess( top.dataM2S_tdata );
      signalAccess[87] = new CDataSignalAccess( top.dataM2S_tid );
      signalAccess[88] = new CDataSignalAccess( top.dataM2S_tstrb );
      signalAccess[89] = new CDataSignalAccess( top.dataM2S_tkeep );
      signalAccess[90] = new CDataSignalAccess( top.dataM2S_tlast );
      signalAccess[91] = new CDataSignalAccess( top.intrS2M );
      signalAccess[92] = new CDataSignalAccess( top.intrM2S );
      signalAccess[93] = new CDataSignalAccess( top.clk );
      signalAccess[94] = new CDataSignalAccess( top.reset );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/AxiLite4BDMA/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/AxiLite4BDMA/") + name + ".dat").c_str());
      #endif
    }
