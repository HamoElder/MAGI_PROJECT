...
VL_INLINE_OPT void VConvCombTest::_sequent__TOP__95(VConvCombTest__Syms* __restrict vlSymsp) {
    ...
    if (vlTOPp->reset) {
        vlTOPp->ConvCombTest__DOT__decoded_fifo__DOT__logic_risingOccupancy = 0U;
    } else {
        if (((IData)(vlTOPp->ConvCombTest__DOT__decoded_fifo__DOT__logic_pushing) 
             != (IData)(vlTOPp->ConvCombTest__DOT__decoded_fifo_io_pop_valid))) {
            vlTOPp->ConvCombTest__DOT__decoded_fifo__DOT__logic_risingOccupancy 
    ...
    vlTOPp->ConvCombTest__DOT__decoded_fifo__DOT__logic_popPtr_value 
        = ((IData)(vlTOPp->reset) ? 0U : (IData)(vlTOPp->ConvCombTest__DOT__decoded_fifo__DOT__logic_popPtr_valueNext));
    vlTOPp->ConvCombTest__DOT__decoded_fifo__DOT___zz_io_pop_valid 
        = ((~ (IData)(vlTOPp->reset)) & ((IData)(vlTOPp->ConvCombTest__DOT__decoded_fifo__DOT__logic_popPtr_valueNext) 
...
VL_INLINE_OPT void VConvCombTest::_sequent__TOP__96(VConvCombTest__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->ConvCombTest__DOT__decoded_fifo__DOT__logic_pushPtr_value 
        = ((IData)(vlTOPp->reset) ? 0U : (IData)(vlTOPp->ConvCombTest__DOT__decoded_fifo__DOT__logic_pushPtr_valueNext));
