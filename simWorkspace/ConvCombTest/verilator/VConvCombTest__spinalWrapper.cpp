...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[10] = new CDataSignalAccess( top.sel );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/ConvCombTest/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/ConvCombTest/") + name + ".dat").c_str());
      #endif
    }
