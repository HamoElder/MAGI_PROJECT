...
#include "VStreamPlayer.h"
#ifdef TRACE
#include "verilated_vcd_c.h"
#endif
#include "VStreamPlayer__Syms.h"
...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[19] = new CDataSignalAccess( top.data_master_valid );
      signalAccess[20] = new CDataSignalAccess( top.data_master_ready );
      signalAccess[21] = new IDataSignalAccess( top.data_master_payload );
      signalAccess[22] = new CDataSignalAccess( top.clk );
      signalAccess[23] = new CDataSignalAccess( top.reset );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/StreamPlayer/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/StreamPlayer/") + name + ".dat").c_str());
      #endif
    }
