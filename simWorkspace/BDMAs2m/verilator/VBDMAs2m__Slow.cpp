...
void VBDMAs2m::_ctor_var_reset() {
    ...
    BDMAs2m__DOT___zz_when_BDMAs2m_l102 = VL_RAND_RESET_I(32);
    BDMAs2m__DOT___zz_when_BDMAs2m_l137_1 = VL_RAND_RESET_I(32);
    BDMAs2m__DOT___zz_s2m_axis_strb_keep_1 = VL_RAND_RESET_I(11);
    BDMAs2m__DOT___zz_s2m_axis_strb_keep_2 = VL_RAND_RESET_I(11);
    ...
    BDMAs2m__DOT__s2m_mask_shift = VL_RAND_RESET_I(2);
    BDMAs2m__DOT__s2m_cch_fire = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__when_BDMAs2m_l86 = VL_RAND_RESET_I(1);
    ...
    BDMAs2m__DOT__trans_pending = VL_RAND_RESET_I(30);
    BDMAs2m__DOT__dma_aw_fire_1 = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__aw_finish = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__s2m_axis_valve = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__s2m_axis_data = VL_RAND_RESET_I(32);
    BDMAs2m__DOT__s2m_axis_residual_data = VL_RAND_RESET_I(32);
    BDMAs2m__DOT__s2m_axis_strb_keep = VL_RAND_RESET_I(4);
    BDMAs2m__DOT__s2m_axis_residual_strb_keep = VL_RAND_RESET_I(4);
    BDMAs2m__DOT__s2m_axis_trans_bytes = VL_RAND_RESET_I(30);
    BDMAs2m__DOT__s2m_axis_req = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__s2m_axis_first = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__s2m_axis_last_cycle = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__s2m_axis_final_last = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__s2m_axis_leak = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__s2m_w_len = VL_RAND_RESET_I(8);
    ...
    BDMAs2m__DOT__s2m_w_final_mask = VL_RAND_RESET_I(4);
    BDMAs2m__DOT__pending_fifo_pop_ready = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__len_pending_fifo_io_pop_fire = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__when_BDMAs2m_l271 = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__when_BDMAs2m_l274 = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__when_BDMAs2m_l326 = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__when_BDMAs2m_l331 = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__when_BDMAs2m_l345 = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__when_BDMAs2m_l349 = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__when_BDMAs2m_l371 = VL_RAND_RESET_I(1);
    ...
    BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT___zz_logic_ram_port0 = VL_RAND_RESET_I(30);
    BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT___zz_1 = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushPtr_willIncrement = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushPtr_valueNext = VL_RAND_RESET_I(3);
    BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushPtr_value = VL_RAND_RESET_I(3);
    BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_willIncrement = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_valueNext = VL_RAND_RESET_I(3);
    BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_value = VL_RAND_RESET_I(3);
    BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ptrMatch = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_risingOccupancy = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushing = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popping = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_full = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT___zz_io_pop_valid = VL_RAND_RESET_I(1);
    { int __Vi0=0; for (; __Vi0<8; ++__Vi0) {
            BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram[__Vi0] = VL_RAND_RESET_I(30);
    }}
    ...
    BDMAs2m__DOT__trans_pending_fifo__DOT____Vxrand1 = VL_RAND_RESET_I(30);
    BDMAs2m__DOT__trans_pending_fifo__DOT___zz_logic_ram_port0 = VL_RAND_RESET_I(30);
    BDMAs2m__DOT__trans_pending_fifo__DOT___zz_1 = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_willIncrement = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_valueNext = VL_RAND_RESET_I(4);
    BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_value = VL_RAND_RESET_I(4);
    BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_willIncrement = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_valueNext = VL_RAND_RESET_I(4);
    BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_value = VL_RAND_RESET_I(4);
    BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ptrMatch = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__trans_pending_fifo__DOT__logic_risingOccupancy = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushing = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popping = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__trans_pending_fifo__DOT__logic_full = VL_RAND_RESET_I(1);
    BDMAs2m__DOT__trans_pending_fifo__DOT___zz_io_pop_valid = VL_RAND_RESET_I(1);
    { int __Vi0=0; for (; __Vi0<12; ++__Vi0) {
            BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram[__Vi0] = VL_RAND_RESET_I(30);
    }}
    BDMAs2m__DOT__trans_pending_fifo__DOT____Vlvbound2 = VL_RAND_RESET_I(30);
    __Vtableidx1 = 0;
    ...
    __Vdly__BDMAs2m__DOT__s2m_axis_strb_keep = VL_RAND_RESET_I(4);
    __Vdly__BDMAs2m__DOT__s2m_axis_trans_bytes = VL_RAND_RESET_I(30);
    __Vdly__BDMAs2m__DOT__s2m_axis_final_last = VL_RAND_RESET_I(1);
    __Vdly__BDMAs2m__DOT__s2m_w_final_mask = VL_RAND_RESET_I(4);
    __Vdly__BDMAs2m__DOT__cch_address = VL_RAND_RESET_I(32);
    __Vdly__BDMAs2m__DOT__s2m_w_len = VL_RAND_RESET_I(8);
    __Vdly__BDMAs2m__DOT__cch_total_bytes = VL_RAND_RESET_I(30);
    __Vdly__BDMAs2m__DOT__trans_bytes_cnt = VL_RAND_RESET_I(30);
    __Vdlyvdim0__BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram__v0 = 0;
    __Vdlyvval__BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram__v0 = VL_RAND_RESET_I(30);
    __Vdlyvset__BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram__v0 = 0;
    __Vdlyvdim0__BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram__v0 = 0;
    __Vdlyvval__BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram__v0 = VL_RAND_RESET_I(30);
    __Vdlyvset__BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram__v0 = 0;
