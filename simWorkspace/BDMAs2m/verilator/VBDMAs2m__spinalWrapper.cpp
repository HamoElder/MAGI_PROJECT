...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.dma_aw_valid );
      signalAccess[1] = new CDataSignalAccess( top.dma_aw_ready );
      signalAccess[2] = new IDataSignalAccess( top.dma_aw_payload_addr );
      signalAccess[3] = new CDataSignalAccess( top.dma_aw_payload_id );
      signalAccess[4] = new CDataSignalAccess( top.dma_aw_payload_len );
      signalAccess[5] = new CDataSignalAccess( top.dma_aw_payload_size );
      signalAccess[6] = new CDataSignalAccess( top.dma_aw_payload_burst );
      signalAccess[7] = new CDataSignalAccess( top.dma_w_valid );
      signalAccess[8] = new CDataSignalAccess( top.dma_w_ready );
      signalAccess[9] = new IDataSignalAccess( top.dma_w_payload_data );
      signalAccess[10] = new CDataSignalAccess( top.dma_w_payload_strb );
      signalAccess[11] = new CDataSignalAccess( top.dma_w_payload_last );
      signalAccess[12] = new CDataSignalAccess( top.dma_b_valid );
      signalAccess[13] = new CDataSignalAccess( top.dma_b_ready );
      signalAccess[14] = new CDataSignalAccess( top.dma_b_payload_id );
      signalAccess[15] = new CDataSignalAccess( top.dma_b_payload_resp );
      signalAccess[16] = new CDataSignalAccess( top.s2m_data_stream_valid );
      signalAccess[17] = new CDataSignalAccess( top.s2m_data_stream_ready );
      signalAccess[18] = new IDataSignalAccess( top.s2m_data_stream_payload_data );
      signalAccess[19] = new CDataSignalAccess( top.s2m_data_stream_payload_id );
