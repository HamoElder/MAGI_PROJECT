...
void VBDMAs2m::eval() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("/home/missdown/IdeaProjects/MAGI_PROJECT/tmp/job_1/BDMAs2m.v", 19, "",
...
VL_INLINE_OPT void VBDMAs2m::_sequent__TOP__3(VBDMAs2m__Syms* __restrict vlSymsp) {
    ...
    // Body
    vlTOPp->__Vdly__BDMAs2m__DOT__s2m_w_len = vlTOPp->BDMAs2m__DOT__s2m_w_len;
    ...
    vlTOPp->__Vdlyvset__BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram__v0 = 0U;
    vlTOPp->__Vdlyvset__BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram__v0 = 0U;
    __Vdlyvset__BDMAs2m__DOT__s2m_aw_fifo__DOT__logic_ram__v0 = 0U;
    __Vdlyvset__BDMAs2m__DOT__len_pending_fifo__DOT__logic_ram__v0 = 0U;
    ...
    if ((0U != (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_state))) {
        if ((1U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_state))) {
            if (vlTOPp->BDMAs2m__DOT__len_pending_fifo_io_pop_fire) {
                vlTOPp->__Vdly__BDMAs2m__DOT__s2m_w_len 
            ...
            if ((2U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_state))) {
                if (vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l345) {
                    vlTOPp->__Vdly__BDMAs2m__DOT__s2m_w_len 
                        = (0xffU & ((IData)(vlTOPp->BDMAs2m__DOT__s2m_w_len) 
                                    - (IData)(1U)));
                }
            }
        }
    ...
    if ((0U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_cch_state))) {
        ...
        if ((1U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_cch_state))) {
            if ((1U & (~ (IData)(vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l86)))) {
                if (vlTOPp->BDMAs2m__DOT__s2m_aw_fifo_io_push_fire) {
                    vlTOPp->__Vdly__BDMAs2m__DOT__cch_total_bytes 
            ...
            vlTOPp->__Vdly__BDMAs2m__DOT__trans_bytes_cnt 
                = (0x3fffffffU & ((0x40U >= vlTOPp->BDMAs2m__DOT___zz_when_BDMAs2m_l102)
            ...
            if ((2U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_cch_state))) {
                ...
                vlTOPp->__Vdly__BDMAs2m__DOT__trans_bytes_cnt 
                    = (0x3fffffffU & ((0x40U >= vlTOPp->BDMAs2m__DOT___zz_when_BDMAs2m_l102)
                                       ? ((0U != (0xfffffU 
                                                  & (vlTOPp->BDMAs2m__DOT___zz_when_BDMAs2m_l137_1 
                                                     >> 0xcU)))
                                           ? ((IData)(0x1000U) 
                                              - (0xfffU 
                                                 & vlTOPp->BDMAs2m__DOT__cch_address))
    ...
    if (vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT___zz_1) {
        vlTOPp->__Vdlyvval__BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram__v0 
            = vlTOPp->BDMAs2m__DOT__trans_bytes_cnt;
        vlTOPp->__Vdlyvset__BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram__v0 = 1U;
        vlTOPp->__Vdlyvdim0__BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram__v0 
            = vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushPtr_value;
    }
    if (vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT___zz_1) {
        vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT____Vlvbound2 
            = vlTOPp->BDMAs2m__DOT__trans_pending;
        if ((0xbU >= (IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_value))) {
            vlTOPp->__Vdlyvval__BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram__v0 
                = vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT____Vlvbound2;
            vlTOPp->__Vdlyvset__BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram__v0 = 1U;
            vlTOPp->__Vdlyvdim0__BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram__v0 
                = vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_value;
        }
    }
    ...
    if (vlTOPp->BDMAs2m__DOT__len_pending_fifo__DOT___zz_1) {
        ...
        if ((0xbU >= (IData)(vlTOPp->BDMAs2m__DOT__len_pending_fifo__DOT__logic_pushPtr_value))) {
            __Vdlyvval__BDMAs2m__DOT__len_pending_fifo__DOT__logic_ram__v0 
                = vlTOPp->BDMAs2m__DOT__len_pending_fifo__DOT____Vlvbound2;
            __Vdlyvset__BDMAs2m__DOT__len_pending_fifo__DOT__logic_ram__v0 = 1U;
            __Vdlyvdim0__BDMAs2m__DOT__len_pending_fifo__DOT__logic_ram__v0 
    ...
    if (vlTOPp->BDMAs2m__DOT__dma_aw_fire_1) {
        vlTOPp->BDMAs2m__DOT__trans_pending = vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT___zz_logic_ram_port0;
    }
    if ((0U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_cch_state))) {
        if (vlTOPp->BDMAs2m__DOT__s2m_cch_fire) {
            ...
            if ((2U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_state))) {
                if (vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l345) {
                    vlTOPp->BDMAs2m__DOT__s2m_w_data 
                        = vlTOPp->BDMAs2m__DOT__s2m_axis_data;
                }
            }
        }
    }
    if (__Vdlyvset__BDMAs2m__DOT__len_pending_fifo__DOT__logic_ram__v0) {
        vlTOPp->BDMAs2m__DOT__len_pending_fifo__DOT__logic_ram[__Vdlyvdim0__BDMAs2m__DOT__len_pending_fifo__DOT__logic_ram__v0] 
            = __Vdlyvval__BDMAs2m__DOT__len_pending_fifo__DOT__logic_ram__v0;
    }
}
...
VL_INLINE_OPT void VBDMAs2m::_sequent__TOP__4(VBDMAs2m__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->dma_aw_payload_len = (0xffU & (IData)((vlTOPp->BDMAs2m__DOT__s2m_aw_fifo__DOT___zz_logic_ram_port0 
                                                   >> 0x24U)));
    vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT___zz_logic_ram_port0 
        = vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram
        [vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_valueNext];
    if ((0U != (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_state))) {
        if ((1U != (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_state))) {
            if ((2U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_state))) {
                if (vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l271) {
                    VL_EXTEND_WI(127,32, __Vtemp2, vlTOPp->BDMAs2m__DOT__s2m_axis_residual_data);
                    ...
                    VL_EXTEND_WQ(127,64, __Vtemp6, 
                                 (((QData)((IData)(vlTOPp->s2m_data_stream_payload_data)) 
                                   << 0x20U) | (QData)((IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_residual_data))));
                    VL_SHIFTL_WWI(127,127,6, __Vtemp7, __Vtemp6, 
                                  (0x3fU & ((IData)(vlTOPp->BDMAs2m__DOT__s2m_bytes_shift) 
                                            << 3U)));
                    VL_EXTEND_WI(95,32, __Vtemp10, vlTOPp->s2m_data_stream_payload_data);
                    VL_SHIFTL_WWI(95,95,6, __Vtemp11, __Vtemp10, 
                                  (0x3fU & ((IData)(vlTOPp->BDMAs2m__DOT__s2m_bytes_shift) 
                                            << 3U)));
                    vlTOPp->BDMAs2m__DOT__s2m_axis_data 
                        = ((IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_first)
                            ? ((IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_final_last)
                                ? __Vtemp3[1U] : __Vtemp7[1U])
                            : __Vtemp11[0U]);
                }
            }
        }
    }
    if (vlTOPp->__Vdlyvset__BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram__v0) {
        vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram[vlTOPp->__Vdlyvdim0__BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram__v0] 
            = vlTOPp->__Vdlyvval__BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram__v0;
    }
    if ((0U != (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_state))) {
        if ((1U != (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_state))) {
            if ((2U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_state))) {
                if (vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l271) {
                    vlTOPp->BDMAs2m__DOT__s2m_axis_residual_data 
                        = ((IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_final_last)
                            ? 0U : vlTOPp->s2m_data_stream_payload_data);
                }
            }
        }
    }
...
VL_INLINE_OPT void VBDMAs2m::_sequent__TOP__6(VBDMAs2m__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->__Vdly__BDMAs2m__DOT__s2m_w_final_mask 
        = vlTOPp->BDMAs2m__DOT__s2m_w_final_mask;
    vlTOPp->__Vdly__BDMAs2m__DOT__s2m_axis_strb_keep 
        = vlTOPp->BDMAs2m__DOT__s2m_axis_strb_keep;
    vlTOPp->__Vdly__BDMAs2m__DOT__s2m_axis_trans_bytes 
        = vlTOPp->BDMAs2m__DOT__s2m_axis_trans_bytes;
    vlTOPp->__Vdly__BDMAs2m__DOT__s2m_w_state = vlTOPp->BDMAs2m__DOT__s2m_w_state;
    vlTOPp->__Vdly__BDMAs2m__DOT__s2m_axis_final_last 
        = vlTOPp->BDMAs2m__DOT__s2m_axis_final_last;
    vlTOPp->BDMAs2m__DOT__pending_valid = ((~ (IData)(vlTOPp->reset)) 
                                           & (IData)(vlTOPp->BDMAs2m__DOT__dma_aw_fire_1));
    if (vlTOPp->reset) {
        vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_risingOccupancy = 0U;
    } else {
        if (((IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushing) 
             != (IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popping))) {
            vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_risingOccupancy 
                = vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushing;
        }
    }
    if (vlTOPp->reset) {
        vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_risingOccupancy = 0U;
    } else {
        if (((IData)(vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushing) 
             != (IData)(vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popping))) {
            vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_risingOccupancy 
                = vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushing;
        }
    }
    if (vlTOPp->reset) {
    ...
    vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_value 
        = ((IData)(vlTOPp->reset) ? 0U : (IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_valueNext));
    vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_value 
        = ((IData)(vlTOPp->reset) ? 0U : (IData)(vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_valueNext));
    vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT___zz_io_pop_valid 
        = ((~ (IData)(vlTOPp->reset)) & ((IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_valueNext) 
                                         == (IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_value)));
    vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT___zz_io_pop_valid 
        = ((~ (IData)(vlTOPp->reset)) & ((IData)(vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_valueNext) 
                                         == (IData)(vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushPtr_value)));
    if (vlTOPp->reset) {
        vlTOPp->__Vdly__BDMAs2m__DOT__s2m_w_state = 0U;
        vlTOPp->BDMAs2m__DOT__s2m_axis_valve = 0U;
        vlTOPp->__Vdly__BDMAs2m__DOT__s2m_axis_strb_keep = 0U;
        vlTOPp->BDMAs2m__DOT__s2m_axis_residual_strb_keep = 0U;
        vlTOPp->__Vdly__BDMAs2m__DOT__s2m_axis_trans_bytes = 0U;
        vlTOPp->BDMAs2m__DOT__s2m_axis_req = 0U;
        vlTOPp->BDMAs2m__DOT__s2m_axis_first = 0U;
        vlTOPp->BDMAs2m__DOT__s2m_axis_last_cycle = 0U;
        vlTOPp->__Vdly__BDMAs2m__DOT__s2m_axis_final_last = 0U;
        vlTOPp->BDMAs2m__DOT__s2m_axis_leak = 0U;
        vlTOPp->BDMAs2m__DOT__s2m_w_last = 0U;
        vlTOPp->BDMAs2m__DOT__s2m_w_strb = 0U;
        vlTOPp->BDMAs2m__DOT__s2m_w_valid = 0U;
        vlTOPp->__Vdly__BDMAs2m__DOT__s2m_w_final_mask = 0U;
        ...
        if ((0U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_state))) {
            ...
            if ((1U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_state))) {
                if (vlTOPp->BDMAs2m__DOT__len_pending_fifo_io_pop_fire) {
                    vlTOPp->__Vdly__BDMAs2m__DOT__s2m_axis_trans_bytes 
                        = (0x3fffffffU & (vlTOPp->BDMAs2m__DOT__s2m_axis_trans_bytes 
                                          + vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT___zz_logic_ram_port0));
                    vlTOPp->BDMAs2m__DOT__pending_fifo_pop_ready = 0U;
                    vlTOPp->__Vdly__BDMAs2m__DOT__s2m_w_state = 2U;
                    vlTOPp->BDMAs2m__DOT__s2m_axis_valve 
                        = (1U & (~ (IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_final_last)));
                } else {
                ...
                if ((2U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_state))) {
                    if (vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l345) {
                        ...
                        vlTOPp->BDMAs2m__DOT__s2m_w_strb 
                            = ((IData)(vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l349)
                                ? ((IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_strb_keep) 
                                   & (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_final_mask))
                                : (IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_strb_keep));
                        if ((0U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_len))) {
                            vlTOPp->BDMAs2m__DOT__s2m_w_last = 1U;
                            vlTOPp->__Vdly__BDMAs2m__DOT__s2m_w_state 
                                = ((IData)(vlTOPp->BDMAs2m__DOT__aw_finish)
                                    ? 3U : 1U);
                            vlTOPp->BDMAs2m__DOT__pending_fifo_pop_ready 
                                = (1U & (~ (IData)(vlTOPp->BDMAs2m__DOT__aw_finish)));
                        } else {
                            vlTOPp->BDMAs2m__DOT__s2m_w_last = 0U;
                        }
                    } else {
                    ...
                    if (vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l271) {
                        vlTOPp->BDMAs2m__DOT__s2m_axis_first = 1U;
                        vlTOPp->BDMAs2m__DOT__s2m_axis_req = 1U;
                        vlTOPp->__Vdly__BDMAs2m__DOT__s2m_axis_strb_keep 
                            = (0xfU & ((IData)(vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l274)
                                        ? (0x7fU & 
                                           ((IData)(vlTOPp->s2m_data_stream_payload_keep_) 
                                            << (IData)(vlTOPp->BDMAs2m__DOT__s2m_bytes_shift)))
                                        : ((IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_final_last)
                                            ? ((IData)(vlTOPp->BDMAs2m__DOT___zz_s2m_axis_strb_keep_1) 
                                               >> 4U)
                                            : ((IData)(vlTOPp->BDMAs2m__DOT___zz_s2m_axis_strb_keep_2) 
                                               >> 4U))));
                        if (vlTOPp->BDMAs2m__DOT__s2m_axis_final_last) {
                            vlTOPp->BDMAs2m__DOT__s2m_axis_residual_strb_keep = 0U;
                        } else {
                            vlTOPp->__Vdly__BDMAs2m__DOT__s2m_axis_trans_bytes 
                                = (0x3fffffffU & (vlTOPp->BDMAs2m__DOT__s2m_axis_trans_bytes 
                                                  - (IData)(4U)));
                            vlTOPp->BDMAs2m__DOT__s2m_axis_residual_strb_keep 
                                = vlTOPp->s2m_data_stream_payload_keep_;
                        }
                        if (vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l326) {
                            vlTOPp->BDMAs2m__DOT__s2m_axis_last_cycle = 1U;
                            vlTOPp->__Vdly__BDMAs2m__DOT__s2m_axis_final_last = 1U;
                            vlTOPp->BDMAs2m__DOT__s2m_axis_valve = 0U;
                        } else {
                            if (vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l331) {
                                vlTOPp->BDMAs2m__DOT__s2m_axis_valve = 0U;
                                vlTOPp->BDMAs2m__DOT__s2m_axis_last_cycle 
                                    = vlTOPp->BDMAs2m__DOT__aw_finish;
                            } else {
                                vlTOPp->BDMAs2m__DOT__s2m_axis_last_cycle = 0U;
                            }
                        }
                    ...
                    vlTOPp->BDMAs2m__DOT__s2m_w_valid = 0U;
                    if (vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l371) {
                        vlTOPp->__Vdly__BDMAs2m__DOT__s2m_w_state = 0U;
                        vlTOPp->BDMAs2m__DOT__s2m_axis_leak = 0U;
                    } else {
...
VL_INLINE_OPT void VBDMAs2m::_sequent__TOP__7(VBDMAs2m__Syms* __restrict vlSymsp) {
    ...
    VBDMAs2m* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->BDMAs2m__DOT__s2m_axis_strb_keep = vlTOPp->__Vdly__BDMAs2m__DOT__s2m_axis_strb_keep;
    vlTOPp->BDMAs2m__DOT__s2m_w_final_mask = vlTOPp->__Vdly__BDMAs2m__DOT__s2m_w_final_mask;
    vlTOPp->BDMAs2m__DOT__s2m_axis_trans_bytes = vlTOPp->__Vdly__BDMAs2m__DOT__s2m_axis_trans_bytes;
    vlTOPp->BDMAs2m__DOT__s2m_axis_final_last = vlTOPp->__Vdly__BDMAs2m__DOT__s2m_axis_final_last;
    vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_value 
        = ((IData)(vlTOPp->reset) ? 0U : (IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_valueNext));
    vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushPtr_value 
        = ((IData)(vlTOPp->reset) ? 0U : (IData)(vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushPtr_valueNext));
    vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l331 = (4U >= vlTOPp->BDMAs2m__DOT__s2m_axis_trans_bytes);
    vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l274 = (1U & 
                                               (~ (IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_first)));
    vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l345 = ((IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_req) 
                                               | (IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_last_cycle));
    if (vlTOPp->reset) {
        ...
        vlTOPp->BDMAs2m__DOT__s2m_bytes_shift = 0U;
        vlTOPp->BDMAs2m__DOT__s2m_mask_shift = 0U;
    } else {
        if ((0U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_cch_state))) {
            if (vlTOPp->BDMAs2m__DOT__s2m_cch_fire) {
                vlTOPp->BDMAs2m__DOT__cch_ready = 0U;
                vlTOPp->BDMAs2m__DOT__s2m_bytes_shift 
                    = (3U & vlTOPp->s2m_cch_payload_desc_start_addr);
                vlTOPp->BDMAs2m__DOT__s2m_mask_shift 
                    = (3U & (vlTOPp->s2m_cch_payload_desc_start_addr 
                             + vlTOPp->s2m_cch_payload_desc_total_bytes));
    ...
    vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ptrMatch 
        = ((IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_value) 
           == (IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_value));
    vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ptrMatch 
        = ((IData)(vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushPtr_value) 
           == (IData)(vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_value));
    vlTOPp->BDMAs2m__DOT___zz_s2m_axis_strb_keep_1 
        = (0x7ffU & ((IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_residual_strb_keep) 
                     << (IData)(vlTOPp->BDMAs2m__DOT__s2m_bytes_shift)));
    ...
    if (vlTOPp->reset) {
        ...
        if ((0U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_cch_state))) {
            ...
            if (((3U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_state)) 
                 & (IData)(vlTOPp->BDMAs2m__DOT__aw_finish))) {
    ...
    vlTOPp->BDMAs2m__DOT__len_pending_fifo__DOT__logic_ptrMatch 
        = ((IData)(vlTOPp->BDMAs2m__DOT__len_pending_fifo__DOT__logic_pushPtr_value) 
           == (IData)(vlTOPp->BDMAs2m__DOT__len_pending_fifo__DOT__logic_popPtr_value));
    vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_full 
        = ((IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ptrMatch) 
           & (IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_risingOccupancy));
    vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_full 
    ...
    vlTOPp->s2m_data_stream_ready = (((IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_valve) 
    ...
    vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popping 
        = (((~ ((IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ptrMatch) 
                & (~ (IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_risingOccupancy)))) 
...
VL_INLINE_OPT void VBDMAs2m::_sequent__TOP__8(VBDMAs2m__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->BDMAs2m__DOT__len_pending_fifo_io_pop_valid 
        = (1U & ((~ ((IData)(vlTOPp->BDMAs2m__DOT__len_pending_fifo__DOT__logic_ptrMatch) 
                 ...
                 & (~ ((IData)(vlTOPp->BDMAs2m__DOT__len_pending_fifo__DOT___zz_io_pop_valid) 
                       & (~ (IData)(vlTOPp->BDMAs2m__DOT__len_pending_fifo__DOT__logic_full))))));
    vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT___zz_1 = 0U;
    if (vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushing) {
        vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT___zz_1 = 1U;
    }
    vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_willIncrement = 0U;
    if (vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushing) {
        vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_willIncrement = 1U;
    }
    vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_willIncrement = 0U;
    if (vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popping) {
        vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_willIncrement = 1U;
    }
    vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT___zz_1 = 0U;
    if (vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushing) {
        vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT___zz_1 = 1U;
    }
    vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushPtr_willIncrement = 0U;
    if (vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushing) {
        vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushPtr_willIncrement = 1U;
    }
    ...
    vlTOPp->BDMAs2m__DOT__len_pending_fifo_io_pop_fire 
        = ((IData)(vlTOPp->BDMAs2m__DOT__len_pending_fifo_io_pop_valid) 
           & (IData)(vlTOPp->BDMAs2m__DOT__pending_fifo_pop_ready));
    vlTOPp->BDMAs2m__DOT__aw_finish = (((3U == (IData)(vlTOPp->BDMAs2m__DOT__s2m_cch_state)) 
                                        & (~ (IData)(vlTOPp->BDMAs2m__DOT__len_pending_fifo_io_pop_valid))) 
                                       & (~ (IData)(vlTOPp->BDMAs2m__DOT__s2m_aw_fifo_io_pop_valid)));
    vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_valueNext 
        = (((0xbU == (IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_value)) 
            & (IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_willIncrement))
            ? 0U : (0xfU & ((IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_value) 
                            + (IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_willIncrement))));
    vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushPtr_valueNext 
        = (7U & ((IData)(vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushPtr_value) 
...
VL_INLINE_OPT void VBDMAs2m::_sequent__TOP__11(VBDMAs2m__Syms* __restrict vlSymsp) {
    ...
    VBDMAs2m* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->BDMAs2m__DOT__s2m_w_len = vlTOPp->__Vdly__BDMAs2m__DOT__s2m_w_len;
    vlTOPp->BDMAs2m__DOT__cch_total_bytes = vlTOPp->__Vdly__BDMAs2m__DOT__cch_total_bytes;
    vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT___zz_logic_ram_port0 
        = ((0xbU >= (IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_valueNext))
            ? vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram
           [vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_valueNext]
            : vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT____Vxrand1);
    vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l86 = (0U == vlTOPp->BDMAs2m__DOT__cch_total_bytes);
    vlTOPp->BDMAs2m__DOT___zz_when_BDMAs2m_l102 = (vlTOPp->BDMAs2m__DOT__cch_total_bytes 
                                                   + 
                                                   (3U 
                                                    & vlTOPp->BDMAs2m__DOT__cch_address));
    vlTOPp->BDMAs2m__DOT___zz_when_BDMAs2m_l137_1 = 
    ...
    if (vlTOPp->__Vdlyvset__BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram__v0) {
        vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram[vlTOPp->__Vdlyvdim0__BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram__v0] 
            = vlTOPp->__Vdlyvval__BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram__v0;
    }
}
...
VL_INLINE_OPT void VBDMAs2m::_combo__TOP__12(VBDMAs2m__Syms* __restrict vlSymsp) {
    ...
    VBDMAs2m* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l326 = ((IData)(vlTOPp->s2m_data_stream_payload_last) 
                                               | (IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_final_last));
    vlTOPp->BDMAs2m__DOT___zz_s2m_axis_strb_keep_2 
        = (0x7ffU & ((((IData)(vlTOPp->s2m_data_stream_payload_keep_) 
                       << 4U) | (IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_residual_strb_keep)) 
                     << (IData)(vlTOPp->BDMAs2m__DOT__s2m_bytes_shift)));
    vlTOPp->BDMAs2m__DOT__s2m_cch_fire = ((IData)(vlTOPp->s2m_cch_valid) 
                                          & (IData)(vlTOPp->s2m_cch_ready));
    vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l271 = (((IData)(vlTOPp->s2m_data_stream_valid) 
                                                & (IData)(vlTOPp->s2m_data_stream_ready)) 
                                               | (IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_final_last));
    vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l371 = ((IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_final_last) 
    ...
    vlTOPp->BDMAs2m__DOT__dma_aw_fire_1 = ((IData)(vlTOPp->dma_aw_valid) 
                                           & (IData)(vlTOPp->dma_aw_ready));
    vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popping 
        = (((~ ((IData)(vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ptrMatch) 
                & (~ (IData)(vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_risingOccupancy)))) 
    ...
    vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_willIncrement = 0U;
    if (vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popping) {
        vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_willIncrement = 1U;
    }
    vlTOPp->BDMAs2m__DOT__s2m_w_fifo__DOT__logic_popPtr_valueNext 
    ...
    vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_valueNext 
        = (7U & ((IData)(vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_value) 
                 + (IData)(vlTOPp->BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_willIncrement)));
}

VL_INLINE_OPT void VBDMAs2m::_sequent__TOP__13(VBDMAs2m__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBDMAs2m::_sequent__TOP__13\n"); );
    VBDMAs2m* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->BDMAs2m__DOT__when_BDMAs2m_l349 = (((IData)(vlTOPp->BDMAs2m__DOT__s2m_axis_last_cycle) 
                                                & (0U 
                                                   == (IData)(vlTOPp->BDMAs2m__DOT__s2m_w_len))) 
                                               & (IData)(vlTOPp->BDMAs2m__DOT__aw_finish));
    vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_valueNext 
        = (((0xbU == (IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_value)) 
            & (IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_willIncrement))
            ? 0U : (0xfU & ((IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_value) 
                            + (IData)(vlTOPp->BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_willIncrement))));
}
