...
VL_MODULE(VBDMAs2m) {
  public:
    ...
    struct {
        ...
        CData/*1:0*/ BDMAs2m__DOT__s2m_mask_shift;
        CData/*0:0*/ BDMAs2m__DOT__s2m_cch_fire;
        CData/*0:0*/ BDMAs2m__DOT__when_BDMAs2m_l86;
        CData/*0:0*/ BDMAs2m__DOT__s2m_aw_fifo_io_push_fire;
        CData/*0:0*/ BDMAs2m__DOT__pending_valid;
        CData/*7:0*/ BDMAs2m__DOT__len_pending;
        CData/*0:0*/ BDMAs2m__DOT__dma_aw_fire_1;
        CData/*0:0*/ BDMAs2m__DOT__aw_finish;
        CData/*0:0*/ BDMAs2m__DOT__s2m_axis_valve;
        CData/*3:0*/ BDMAs2m__DOT__s2m_axis_strb_keep;
        CData/*3:0*/ BDMAs2m__DOT__s2m_axis_residual_strb_keep;
        CData/*0:0*/ BDMAs2m__DOT__s2m_axis_req;
        CData/*0:0*/ BDMAs2m__DOT__s2m_axis_first;
        CData/*0:0*/ BDMAs2m__DOT__s2m_axis_last_cycle;
        CData/*0:0*/ BDMAs2m__DOT__s2m_axis_final_last;
        CData/*0:0*/ BDMAs2m__DOT__s2m_axis_leak;
        CData/*7:0*/ BDMAs2m__DOT__s2m_w_len;
        CData/*0:0*/ BDMAs2m__DOT__s2m_w_last;
        CData/*3:0*/ BDMAs2m__DOT__s2m_w_strb;
        CData/*0:0*/ BDMAs2m__DOT__s2m_w_valid;
        CData/*3:0*/ BDMAs2m__DOT__s2m_w_final_mask;
        CData/*0:0*/ BDMAs2m__DOT__pending_fifo_pop_ready;
        CData/*0:0*/ BDMAs2m__DOT__len_pending_fifo_io_pop_fire;
        CData/*0:0*/ BDMAs2m__DOT__when_BDMAs2m_l271;
        CData/*0:0*/ BDMAs2m__DOT__when_BDMAs2m_l274;
        CData/*0:0*/ BDMAs2m__DOT__when_BDMAs2m_l326;
        CData/*0:0*/ BDMAs2m__DOT__when_BDMAs2m_l331;
        CData/*0:0*/ BDMAs2m__DOT__when_BDMAs2m_l345;
        CData/*0:0*/ BDMAs2m__DOT__when_BDMAs2m_l349;
        CData/*0:0*/ BDMAs2m__DOT__when_BDMAs2m_l371;
        ...
        CData/*0:0*/ BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT___zz_1;
        CData/*0:0*/ BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushPtr_willIncrement;
        CData/*2:0*/ BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushPtr_valueNext;
        CData/*2:0*/ BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushPtr_value;
        CData/*0:0*/ BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_willIncrement;
        CData/*2:0*/ BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_valueNext;
        CData/*2:0*/ BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popPtr_value;
        CData/*0:0*/ BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ptrMatch;
    };
    struct {
        CData/*0:0*/ BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_risingOccupancy;
        CData/*0:0*/ BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_pushing;
        CData/*0:0*/ BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_popping;
        CData/*0:0*/ BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_full;
        CData/*0:0*/ BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT___zz_io_pop_valid;
        ...
        CData/*0:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT___zz_1;
        CData/*0:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_willIncrement;
        CData/*3:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_valueNext;
        CData/*3:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushPtr_value;
        CData/*0:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_willIncrement;
        CData/*3:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_valueNext;
        CData/*3:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popPtr_value;
        CData/*0:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ptrMatch;
        CData/*0:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT__logic_risingOccupancy;
        CData/*0:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT__logic_pushing;
        CData/*0:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT__logic_popping;
        CData/*0:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT__logic_full;
        CData/*0:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT___zz_io_pop_valid;
        SData/*10:0*/ BDMAs2m__DOT___zz_s2m_axis_strb_keep_1;
        SData/*10:0*/ BDMAs2m__DOT___zz_s2m_axis_strb_keep_2;
        IData/*31:0*/ BDMAs2m__DOT___zz_when_BDMAs2m_l102;
        IData/*31:0*/ BDMAs2m__DOT___zz_when_BDMAs2m_l137_1;
        IData/*29:0*/ BDMAs2m__DOT__cch_total_bytes;
        IData/*31:0*/ BDMAs2m__DOT__cch_address;
        IData/*29:0*/ BDMAs2m__DOT__trans_bytes_cnt;
        IData/*29:0*/ BDMAs2m__DOT__trans_pending;
        IData/*31:0*/ BDMAs2m__DOT__s2m_axis_data;
        IData/*31:0*/ BDMAs2m__DOT__s2m_axis_residual_data;
        IData/*29:0*/ BDMAs2m__DOT__s2m_axis_trans_bytes;
        IData/*31:0*/ BDMAs2m__DOT__s2m_w_data;
        WData/*71:0*/ BDMAs2m__DOT__s2m_cch_state_string[3];
        IData/*29:0*/ BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT___zz_logic_ram_port0;
        IData/*29:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT___zz_logic_ram_port0;
        ...
        IData/*29:0*/ BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram[8];
    };
    struct {
        QData/*36:0*/ BDMAs2m__DOT__s2m_w_fifo__DOT__logic_ram[32];
        CData/*7:0*/ BDMAs2m__DOT__len_pending_fifo__DOT__logic_ram[12];
        IData/*29:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram[12];
    };
    ...
    CData/*3:0*/ __Vdly__BDMAs2m__DOT__s2m_axis_strb_keep;
    CData/*0:0*/ __Vdly__BDMAs2m__DOT__s2m_axis_final_last;
    CData/*3:0*/ __Vdly__BDMAs2m__DOT__s2m_w_final_mask;
    CData/*7:0*/ __Vdly__BDMAs2m__DOT__s2m_w_len;
    CData/*2:0*/ __Vdlyvdim0__BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram__v0;
    CData/*0:0*/ __Vdlyvset__BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram__v0;
    CData/*3:0*/ __Vdlyvdim0__BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram__v0;
    CData/*0:0*/ __Vdlyvset__BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram__v0;
    CData/*0:0*/ __Vclklast__TOP__clk;
    CData/*0:0*/ __Vclklast__TOP__reset;
    IData/*29:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT____Vxrand1;
    IData/*29:0*/ BDMAs2m__DOT__trans_pending_fifo__DOT____Vlvbound2;
    IData/*29:0*/ __Vdly__BDMAs2m__DOT__s2m_axis_trans_bytes;
    ...
    IData/*29:0*/ __Vdlyvval__BDMAs2m__DOT__s2m_trans_bytes_fifo__DOT__logic_ram__v0;
    IData/*29:0*/ __Vdlyvval__BDMAs2m__DOT__trans_pending_fifo__DOT__logic_ram__v0;
  ...
  public:
    ...
    static void _sequent__TOP__13(VBDMAs2m__Syms* __restrict vlSymsp);
    ...
    static void traceFullThis__10(VBDMAs2m__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) VL_ATTR_COLD;
