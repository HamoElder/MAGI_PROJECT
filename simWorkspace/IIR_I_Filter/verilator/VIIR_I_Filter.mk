...
#    make -f VIIR_I_Filter.mk

default: VIIR_I_Filter
...
VM_PREFIX = VIIR_I_Filter
# Module prefix (from --prefix)
VM_MODPREFIX = VIIR_I_Filter
...
include VIIR_I_Filter_classes.mk
...
VIIR_I_Filter__spinalWrapper.o: verilator/VIIR_I_Filter__spinalWrapper.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
VIIR_I_Filter: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
