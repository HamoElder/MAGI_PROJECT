...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.clc );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/crystal/project/MAGI_PROJECT/./simWorkspace/IIR_I_Filter/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/crystal/project/MAGI_PROJECT/./simWorkspace/IIR_I_Filter/") + name + ".dat").c_str());
      #endif
    }
