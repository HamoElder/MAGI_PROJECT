...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[2] = new IDataSignalAccess( top.w_data );
      signalAccess[3] = new CDataSignalAccess( top.w_sel );
      signalAccess[4] = new CDataSignalAccess( top.iq_shift );
      signalAccess[5] = new CDataSignalAccess( top.data_flow_mod_iq_valid );
      signalAccess[6] = new SDataSignalAccess( top.data_flow_mod_iq_payload_cha_i );
      signalAccess[7] = new SDataSignalAccess( top.data_flow_mod_iq_payload_cha_q );
      signalAccess[8] = new CDataSignalAccess( top.data_flow_unit_data_valid );
      signalAccess[9] = new CDataSignalAccess( top.data_flow_unit_data_payload );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/lookUpDemod/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/lookUpDemod/") + name + ".dat").c_str());
      #endif
    }
