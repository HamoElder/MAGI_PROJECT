...
VM_PREFIX = VDecimator
# Module prefix (from --prefix)
VM_MODPREFIX = VDecimator
...
VDecimator__spinalWrapper.o: verilator/VDecimator__spinalWrapper.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
VDecimator: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
