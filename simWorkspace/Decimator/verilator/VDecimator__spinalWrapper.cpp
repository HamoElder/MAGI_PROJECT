...
public:
    ...
    Wrapper_1(const char * name){
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/crystal/project/MAGI_PROJECT/./simWorkspace/Decimator/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/crystal/project/MAGI_PROJECT/./simWorkspace/Decimator/") + name + ".dat").c_str());
      #endif
    }
