...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.in_valid );
      signalAccess[1] = new SDataSignalAccess( top.in_payload );
      signalAccess[2] = new CDataSignalAccess( top.out_valid );
      signalAccess[3] = new SDataSignalAccess( top.out_payload );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/Decimator/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/Decimator/") + name + ".dat").c_str());
      #endif
    }
