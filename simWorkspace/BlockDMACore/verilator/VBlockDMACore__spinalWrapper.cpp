...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.axi4Data_ar_valid );
      signalAccess[1] = new CDataSignalAccess( top.axi4Data_ar_ready );
      signalAccess[2] = new SDataSignalAccess( top.axi4Data_ar_payload_addr );
      signalAccess[3] = new CDataSignalAccess( top.axi4Data_ar_payload_id );
      signalAccess[4] = new CDataSignalAccess( top.axi4Data_ar_payload_len );
      signalAccess[5] = new CDataSignalAccess( top.axi4Data_ar_payload_size );
      signalAccess[6] = new CDataSignalAccess( top.axi4Data_ar_payload_burst );
      signalAccess[7] = new CDataSignalAccess( top.axi4Data_r_valid );
      signalAccess[8] = new CDataSignalAccess( top.axi4Data_r_ready );
      signalAccess[9] = new IDataSignalAccess( top.axi4Data_r_payload_data );
      signalAccess[10] = new CDataSignalAccess( top.axi4Data_r_payload_id );
      signalAccess[11] = new CDataSignalAccess( top.axi4Data_r_payload_resp );
      signalAccess[12] = new CDataSignalAccess( top.axi4Data_r_payload_last );
      signalAccess[13] = new CDataSignalAccess( top.m2s_desc_valid );
      signalAccess[14] = new CDataSignalAccess( top.m2s_desc_ready );
      signalAccess[15] = new SDataSignalAccess( top.m2s_desc_addr );
      signalAccess[16] = new IDataSignalAccess( top.m2s_desc_total_bytes );
      signalAccess[17] = new CDataSignalAccess( top.m2s_desc_burst );
      signalAccess[18] = new CDataSignalAccess( top.m2s_desc_id );
      signalAccess[19] = new CDataSignalAccess( top.m2s_intr_en );
      signalAccess[20] = new CDataSignalAccess( top.intr_m2s );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/crystal/project/MAGI_PROJECT/./simWorkspace/BlockDMACore/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/crystal/project/MAGI_PROJECT/./simWorkspace/BlockDMACore/") + name + ".dat").c_str());
      #endif
    }
