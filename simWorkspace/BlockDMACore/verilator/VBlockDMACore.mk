...
#    make -f VBlockDMACore.mk

default: VBlockDMACore
...
VM_PREFIX = VBlockDMACore
# Module prefix (from --prefix)
VM_MODPREFIX = VBlockDMACore
...
include VBlockDMACore_classes.mk
...
VBlockDMACore__spinalWrapper.o: verilator/VBlockDMACore__spinalWrapper.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
VBlockDMACore: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
