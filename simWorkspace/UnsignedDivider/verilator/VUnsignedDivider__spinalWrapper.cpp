...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[5] = new CDataSignalAccess( top.rsp_valid );
      signalAccess[6] = new CDataSignalAccess( top.rsp_ready );
      signalAccess[7] = new SDataSignalAccess( top.rsp_payload_quotient );
      signalAccess[8] = new SDataSignalAccess( top.rsp_payload_remainder );
      signalAccess[9] = new CDataSignalAccess( top.rsp_payload_error );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/UnsignedDivider/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/UnsignedDivider/") + name + ".dat").c_str());
      #endif
    }
