...
#    make -f VAxiLite4Gpios.mk

default: VAxiLite4Gpios
...
VM_PREFIX = VAxiLite4Gpios
# Module prefix (from --prefix)
VM_MODPREFIX = VAxiLite4Gpios
...
include VAxiLite4Gpios_classes.mk
...
VAxiLite4Gpios__spinalWrapper.o: verilator/VAxiLite4Gpios__spinalWrapper.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
VAxiLite4Gpios: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
