...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[27] = new SDataSignalAccess( top.result_data_payload_cha_i );
      signalAccess[28] = new SDataSignalAccess( top.result_data_payload_cha_q );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/TXSim/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/TXSim/") + name + ".dat").c_str());
      #endif
    }
