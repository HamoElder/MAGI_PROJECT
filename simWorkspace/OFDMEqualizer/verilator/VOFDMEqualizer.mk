...
#    make -f VOFDMEqualizer.mk

default: VOFDMEqualizer
...
VM_PREFIX = VOFDMEqualizer
# Module prefix (from --prefix)
VM_MODPREFIX = VOFDMEqualizer
...
include VOFDMEqualizer_classes.mk
...
VOFDMEqualizer__spinalWrapper.o: verilator/VOFDMEqualizer__spinalWrapper.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
VOFDMEqualizer: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
