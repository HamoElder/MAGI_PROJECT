...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[3] = new SDataSignalAccess( top.raw_data_payload_fragment_cha_i );
      signalAccess[4] = new SDataSignalAccess( top.raw_data_payload_fragment_cha_q );
      signalAccess[5] = new CDataSignalAccess( top.equalized_data_valid );
      signalAccess[6] = new CDataSignalAccess( top.equalized_data_payload_last );
      signalAccess[7] = new SDataSignalAccess( top.equalized_data_payload_fragment_cha_i );
      signalAccess[8] = new SDataSignalAccess( top.equalized_data_payload_fragment_cha_q );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/OFDMEqualizer/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/OFDMEqualizer/") + name + ".dat").c_str());
      #endif
    }
