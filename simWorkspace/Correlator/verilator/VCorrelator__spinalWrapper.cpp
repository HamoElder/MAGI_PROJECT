...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[1] = new SDataSignalAccess( top.raw_data_0_payload_cha_i );
      signalAccess[2] = new SDataSignalAccess( top.raw_data_0_payload_cha_q );
      signalAccess[3] = new CDataSignalAccess( top.raw_data_1_valid );
      signalAccess[4] = new SDataSignalAccess( top.raw_data_1_payload_cha_i );
      signalAccess[5] = new SDataSignalAccess( top.raw_data_1_payload_cha_q );
      signalAccess[6] = new CDataSignalAccess( top.corr_result_valid );
      signalAccess[7] = new IDataSignalAccess( top.corr_result_payload_cha_i );
      signalAccess[8] = new IDataSignalAccess( top.corr_result_payload_cha_q );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/Correlator/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/Correlator/") + name + ".dat").c_str());
      #endif
    }
