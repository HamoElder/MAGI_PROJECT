...
#    make -f VZeroForcing.mk

default: VZeroForcing
...
VM_PREFIX = VZeroForcing
# Module prefix (from --prefix)
VM_MODPREFIX = VZeroForcing
...
include VZeroForcing_classes.mk
...
VZeroForcing__spinalWrapper.o: verilator/VZeroForcing__spinalWrapper.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
VZeroForcing: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
