...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[2] = new SDataSignalAccess( top.raw_data_payload );
      signalAccess[3] = new SDataSignalAccess( top.scale );
      signalAccess[4] = new SDataSignalAccess( top.ref_data );
      signalAccess[5] = new CDataSignalAccess( top.train_en );
      signalAccess[6] = new CDataSignalAccess( top.result_data_valid );
      signalAccess[7] = new SDataSignalAccess( top.result_data_payload );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/ZeroForcing/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/ZeroForcing/") + name + ".dat").c_str());
      #endif
    }
