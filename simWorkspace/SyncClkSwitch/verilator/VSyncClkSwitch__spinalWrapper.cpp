...
public:
    ...
    Wrapper_1(const char * name){
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/mnt/BackUp/IdeaProjects/MAGI_PROJECT/./simWorkspace/SyncClkSwitch/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/mnt/BackUp/IdeaProjects/MAGI_PROJECT/./simWorkspace/SyncClkSwitch/") + name + ".dat").c_str());
      #endif
    }
