...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[2] = new IDataSignalAccess( top.raw_data_payload );
      signalAccess[3] = new CDataSignalAccess( top.split_data_valid );
      signalAccess[4] = new CDataSignalAccess( top.split_data_ready );
      signalAccess[5] = new CDataSignalAccess( top.split_data_payload );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/StreamPayloadSplit/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/StreamPayloadSplit/") + name + ".dat").c_str());
      #endif
    }
