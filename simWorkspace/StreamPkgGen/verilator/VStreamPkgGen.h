...
VL_MODULE(VStreamPkgGen) {
  public:
    ...
    CData/*0:0*/ StreamPkgGen__DOT__raw_data_last;
    CData/*0:0*/ StreamPkgGen__DOT__raw_data_stream_fire;
    ...
    SData/*11:0*/ StreamPkgGen__DOT___zz_pkg_slices_cnt;
  ...
  public:
    ...
    static void _sequent__TOP__5(VStreamPkgGen__Syms* __restrict vlSymsp);
