...
void VStreamPkgGen::traceChgThis__2(VStreamPkgGen__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        vcdp->chgBit(c+1,(vlTOPp->StreamPkgGen__DOT__split_core__DOT__raw_data_fire));
...
void VStreamPkgGen::traceChgThis__3(VStreamPkgGen__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        vcdp->chgBus(c+17,((0xffU & vlTOPp->StreamPkgGen__DOT__split_core__DOT__data_buf)),8);
        vcdp->chgBus(c+25,(vlTOPp->StreamPkgGen__DOT__strb_buf),4);
        vcdp->chgBit(c+33,((1U & (IData)(vlTOPp->StreamPkgGen__DOT__strb_buf))));
        vcdp->chgBus(c+41,(vlTOPp->StreamPkgGen__DOT__split_core__DOT__data_buf),32);
    }
}
...
void VStreamPkgGen::traceChgThis__4(VStreamPkgGen__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        vcdp->chgBit(c+49,((0U == (IData)(vlTOPp->StreamPkgGen__DOT__split_core__DOT__cnt))));
        vcdp->chgBit(c+57,((0U != (IData)(vlTOPp->StreamPkgGen__DOT__split_core__DOT__cnt))));
        vcdp->chgBus(c+65,(vlTOPp->StreamPkgGen__DOT__split_core__DOT__cnt),3);
    }
}
...
void VStreamPkgGen::traceChgThis__5(VStreamPkgGen__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->chgBit(c+153,(((0U != (IData)(vlTOPp->StreamPkgGen__DOT__split_core__DOT__cnt)) 
