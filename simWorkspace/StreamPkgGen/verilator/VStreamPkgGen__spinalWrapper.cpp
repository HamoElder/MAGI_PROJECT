...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[2] = new CDataSignalAccess( top.raw_data_tvalid );
      signalAccess[3] = new CDataSignalAccess( top.raw_data_tready );
      signalAccess[4] = new IDataSignalAccess( top.raw_data_tdata );
      signalAccess[5] = new CDataSignalAccess( top.raw_data_tstrb );
      signalAccess[6] = new CDataSignalAccess( top.raw_data_tlast );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/StreamPkgGen/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/StreamPkgGen/") + name + ".dat").c_str());
      #endif
    }
