...
#    make -f VCDMADespreading.mk

default: VCDMADespreading
...
VM_PREFIX = VCDMADespreading
# Module prefix (from --prefix)
VM_MODPREFIX = VCDMADespreading
...
VM_USER_CLASSES = \
	VCDMADespreading__spinalWrapper \
...
include VCDMADespreading_classes.mk
...
VCDMADespreading__spinalWrapper.o: verilator/VCDMADespreading__spinalWrapper.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
VCDMADespreading: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
