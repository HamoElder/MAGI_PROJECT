...
public:
    ...
    uint32_t timeCheck;
    bool waveEnabled;
    VCDMADespreading top;
    ISignalAccess *signalAccess[35];
    #ifdef TRACE
	  VerilatedVcdC tfp;
	  #endif
    string name;
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[5] = new CDataSignalAccess( top.mod_iq_valid );
      signalAccess[6] = new CDataSignalAccess( top.mod_iq_ready );
      signalAccess[7] = new SDataSignalAccess( top.mod_iq_payload_cha_i );
      signalAccess[8] = new SDataSignalAccess( top.mod_iq_payload_cha_q );
      signalAccess[9] = new CDataSignalAccess( top.base_sub_iqs_0_valid );
      signalAccess[10] = new SDataSignalAccess( top.base_sub_iqs_0_payload_cha_i );
      signalAccess[11] = new SDataSignalAccess( top.base_sub_iqs_0_payload_cha_q );
      signalAccess[12] = new CDataSignalAccess( top.base_sub_iqs_1_valid );
      signalAccess[13] = new SDataSignalAccess( top.base_sub_iqs_1_payload_cha_i );
      signalAccess[14] = new SDataSignalAccess( top.base_sub_iqs_1_payload_cha_q );
      signalAccess[15] = new CDataSignalAccess( top.base_sub_iqs_2_valid );
      signalAccess[16] = new SDataSignalAccess( top.base_sub_iqs_2_payload_cha_i );
      signalAccess[17] = new SDataSignalAccess( top.base_sub_iqs_2_payload_cha_q );
      signalAccess[18] = new CDataSignalAccess( top.base_sub_iqs_3_valid );
      signalAccess[19] = new SDataSignalAccess( top.base_sub_iqs_3_payload_cha_i );
      signalAccess[20] = new SDataSignalAccess( top.base_sub_iqs_3_payload_cha_q );
      signalAccess[21] = new CDataSignalAccess( top.base_sub_iqs_4_valid );
      signalAccess[22] = new SDataSignalAccess( top.base_sub_iqs_4_payload_cha_i );
      signalAccess[23] = new SDataSignalAccess( top.base_sub_iqs_4_payload_cha_q );
      signalAccess[24] = new CDataSignalAccess( top.base_sub_iqs_5_valid );
      signalAccess[25] = new SDataSignalAccess( top.base_sub_iqs_5_payload_cha_i );
      signalAccess[26] = new SDataSignalAccess( top.base_sub_iqs_5_payload_cha_q );
      signalAccess[27] = new CDataSignalAccess( top.base_sub_iqs_6_valid );
      signalAccess[28] = new SDataSignalAccess( top.base_sub_iqs_6_payload_cha_i );
      signalAccess[29] = new SDataSignalAccess( top.base_sub_iqs_6_payload_cha_q );
      signalAccess[30] = new CDataSignalAccess( top.base_sub_iqs_7_valid );
      signalAccess[31] = new SDataSignalAccess( top.base_sub_iqs_7_payload_cha_i );
      signalAccess[32] = new SDataSignalAccess( top.base_sub_iqs_7_payload_cha_q );
      signalAccess[33] = new CDataSignalAccess( top.clk );
      signalAccess[34] = new CDataSignalAccess( top.reset );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/crystal/project/MAGI_PROJECT/./simWorkspace/CDMADespreading/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/crystal/project/MAGI_PROJECT/./simWorkspace/CDMADespreading/") + name + ".dat").c_str());
      #endif
    }
