...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[19] = new CDataSignalAccess( top.if_iq_0_valid );
      signalAccess[20] = new IDataSignalAccess( top.if_iq_0_payload );
      signalAccess[21] = new CDataSignalAccess( top.carries_iq_valid );
      signalAccess[22] = new SDataSignalAccess( top.carries_iq_payload_cha_i );
      signalAccess[23] = new SDataSignalAccess( top.carries_iq_payload_cha_q );
      signalAccess[24] = new CDataSignalAccess( top.base_iq_0_valid );
      signalAccess[25] = new SDataSignalAccess( top.base_iq_0_payload_cha_i );
      signalAccess[26] = new SDataSignalAccess( top.base_iq_0_payload_cha_q );
      signalAccess[27] = new CDataSignalAccess( top.rf_clk );
      signalAccess[28] = new CDataSignalAccess( top.rf_resetn );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/AxiLite4IQDemixer/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/AxiLite4IQDemixer/") + name + ".dat").c_str());
      #endif
    }
