...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[21] = new SDataSignalAccess( top.base_iq_payload_cha_i );
      signalAccess[22] = new SDataSignalAccess( top.base_iq_payload_cha_q );
      signalAccess[23] = new CDataSignalAccess( top.mod_iq_valid );
      signalAccess[24] = new SDataSignalAccess( top.mod_iq_payload_cha_i );
      signalAccess[25] = new SDataSignalAccess( top.mod_iq_payload_cha_q );
      signalAccess[26] = new CDataSignalAccess( top.rf_clk );
      signalAccess[27] = new CDataSignalAccess( top.rf_resetn );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/crystal/project/MAGI_PROJECT/./simWorkspace/AxiLite4CDMASpreading/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/crystal/project/MAGI_PROJECT/./simWorkspace/AxiLite4CDMASpreading/") + name + ".dat").c_str());
      #endif
    }
