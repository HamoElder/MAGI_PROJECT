...
public:
    ...
    uint32_t timeCheck;
    bool waveEnabled;
    VAxiLite4Modulator top;
    ISignalAccess *signalAccess[29];
    #ifdef TRACE
	  VerilatedVcdC tfp;
	  #endif
    string name;
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.base_data_valid );
      signalAccess[1] = new CDataSignalAccess( top.base_data_ready );
      signalAccess[2] = new IDataSignalAccess( top.base_data_payload );
      signalAccess[3] = new CDataSignalAccess( top.axil4Ctrl_awvalid );
      signalAccess[4] = new CDataSignalAccess( top.axil4Ctrl_awready );
      signalAccess[5] = new CDataSignalAccess( top.axil4Ctrl_awaddr );
      signalAccess[6] = new CDataSignalAccess( top.axil4Ctrl_awprot );
      signalAccess[7] = new CDataSignalAccess( top.axil4Ctrl_wvalid );
      signalAccess[8] = new CDataSignalAccess( top.axil4Ctrl_wready );
      signalAccess[9] = new IDataSignalAccess( top.axil4Ctrl_wdata );
      signalAccess[10] = new CDataSignalAccess( top.axil4Ctrl_wstrb );
      signalAccess[11] = new CDataSignalAccess( top.axil4Ctrl_bvalid );
      signalAccess[12] = new CDataSignalAccess( top.axil4Ctrl_bready );
      signalAccess[13] = new CDataSignalAccess( top.axil4Ctrl_bresp );
      signalAccess[14] = new CDataSignalAccess( top.axil4Ctrl_arvalid );
      signalAccess[15] = new CDataSignalAccess( top.axil4Ctrl_arready );
      signalAccess[16] = new CDataSignalAccess( top.axil4Ctrl_araddr );
      signalAccess[17] = new CDataSignalAccess( top.axil4Ctrl_arprot );
      signalAccess[18] = new CDataSignalAccess( top.axil4Ctrl_rvalid );
      signalAccess[19] = new CDataSignalAccess( top.axil4Ctrl_rready );
      signalAccess[20] = new IDataSignalAccess( top.axil4Ctrl_rdata );
      signalAccess[21] = new CDataSignalAccess( top.axil4Ctrl_rresp );
      signalAccess[22] = new CDataSignalAccess( top.mod_iq_valid );
      signalAccess[23] = new SDataSignalAccess( top.mod_iq_payload_cha_i );
      signalAccess[24] = new SDataSignalAccess( top.mod_iq_payload_cha_q );
      signalAccess[25] = new CDataSignalAccess( top.rf_clk );
      signalAccess[26] = new CDataSignalAccess( top.rf_resetn );
      signalAccess[27] = new CDataSignalAccess( top.clk );
      signalAccess[28] = new CDataSignalAccess( top.reset );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/AxiLite4Modulator/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/AxiLite4Modulator/") + name + ".dat").c_str());
      #endif
    }
