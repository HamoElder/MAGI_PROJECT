...
void VBitonicSort::_settle__TOP__5(VBitonicSort__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->BitonicSort__DOT__when_BitonicSort_l27 
        = (((IData)(vlTOPp->raw_data_valid) & (IData)(vlTOPp->raw_data_ready)) 
           | (0x10U <= (IData)(vlTOPp->BitonicSort__DOT__cnt)));
    vlTOPp->BitonicSort__DOT__cmpUnit_4__DOT__cmp_sel 
        = (1U & ((IData)(vlTOPp->cmp_less) ? (IData)(vlTOPp->BitonicSort__DOT__cmpUnit_4__DOT__cmp_less_result)
                  : (~ (IData)(vlTOPp->BitonicSort__DOT__cmpUnit_4__DOT__cmp_less_result))));
    vlTOPp->BitonicSort__DOT__cmpUnit_4_out1_idx = 
        ((IData)(vlTOPp->BitonicSort__DOT__cmpUnit_4__DOT__cmp_sel)
    ...
    vlTOPp->BitonicSort__DOT__cmpUnit_5__DOT__cmp_sel 
        = (1U & ((IData)(vlTOPp->cmp_less) ? (IData)(vlTOPp->BitonicSort__DOT__cmpUnit_5__DOT__cmp_less_result)
                  : (~ (IData)(vlTOPp->BitonicSort__DOT__cmpUnit_5__DOT__cmp_less_result))));
    vlTOPp->BitonicSort__DOT__cmpUnit_5_out1_idx = 
        ((IData)(vlTOPp->BitonicSort__DOT__cmpUnit_5__DOT__cmp_sel)
    ...
    vlTOPp->BitonicSort__DOT__cmpUnit_6__DOT__cmp_sel 
        = (1U & ((IData)(vlTOPp->cmp_less) ? (IData)(vlTOPp->BitonicSort__DOT__cmpUnit_6__DOT__cmp_less_result)
                  : (~ (IData)(vlTOPp->BitonicSort__DOT__cmpUnit_6__DOT__cmp_less_result))));
    vlTOPp->BitonicSort__DOT__cmpUnit_6_out1_idx = 
        ((IData)(vlTOPp->BitonicSort__DOT__cmpUnit_6__DOT__cmp_sel)
    ...
    vlTOPp->BitonicSort__DOT__cmpUnit_7__DOT__cmp_sel 
        = (1U & ((IData)(vlTOPp->BitonicSort__DOT__when_BitonicSort_l27)
...
void VBitonicSort::_ctor_var_reset() {
    ...
    BitonicSort__DOT__when_BitonicSort_l27 = VL_RAND_RESET_I(1);
    ...
    BitonicSort__DOT__cmpUnit_4__DOT__cmp_sel = VL_RAND_RESET_I(1);
    ...
    BitonicSort__DOT__cmpUnit_5__DOT__cmp_sel = VL_RAND_RESET_I(1);
    ...
    BitonicSort__DOT__cmpUnit_6__DOT__cmp_sel = VL_RAND_RESET_I(1);
