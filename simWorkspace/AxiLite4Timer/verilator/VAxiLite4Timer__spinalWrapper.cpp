...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[19] = new CDataSignalAccess( top.timer_interrupt );
      signalAccess[20] = new CDataSignalAccess( top.oc );
      signalAccess[21] = new CDataSignalAccess( top.oc_n );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/AxiLite4Timer/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/AxiLite4Timer/") + name + ".dat").c_str());
      #endif
    }
