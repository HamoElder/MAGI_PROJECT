...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[19] = new CDataSignalAccess( top.base_iq_valid );
      signalAccess[20] = new CDataSignalAccess( top.base_iq_ready );
      signalAccess[21] = new SDataSignalAccess( top.base_iq_payload_0_cha_i );
      signalAccess[22] = new SDataSignalAccess( top.base_iq_payload_0_cha_q );
      signalAccess[23] = new SDataSignalAccess( top.base_iq_payload_1_cha_i );
      signalAccess[24] = new SDataSignalAccess( top.base_iq_payload_1_cha_q );
      signalAccess[25] = new SDataSignalAccess( top.base_iq_payload_2_cha_i );
      signalAccess[26] = new SDataSignalAccess( top.base_iq_payload_2_cha_q );
      signalAccess[27] = new SDataSignalAccess( top.base_iq_payload_3_cha_i );
      signalAccess[28] = new SDataSignalAccess( top.base_iq_payload_3_cha_q );
      signalAccess[29] = new SDataSignalAccess( top.base_iq_payload_4_cha_i );
      signalAccess[30] = new SDataSignalAccess( top.base_iq_payload_4_cha_q );
      signalAccess[31] = new SDataSignalAccess( top.base_iq_payload_5_cha_i );
      signalAccess[32] = new SDataSignalAccess( top.base_iq_payload_5_cha_q );
      signalAccess[33] = new SDataSignalAccess( top.base_iq_payload_6_cha_i );
      signalAccess[34] = new SDataSignalAccess( top.base_iq_payload_6_cha_q );
      signalAccess[35] = new SDataSignalAccess( top.base_iq_payload_7_cha_i );
      signalAccess[36] = new SDataSignalAccess( top.base_iq_payload_7_cha_q );
      signalAccess[37] = new CDataSignalAccess( top.mod_iq_valid );
      signalAccess[38] = new SDataSignalAccess( top.mod_iq_payload_cha_i );
      signalAccess[39] = new SDataSignalAccess( top.mod_iq_payload_cha_q );
      signalAccess[40] = new CDataSignalAccess( top.rf_clk );
      signalAccess[41] = new CDataSignalAccess( top.rf_resetn );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/crystal/project/MAGI_PROJECT/./simWorkspace/AxiLite4CDMASpread/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/crystal/project/MAGI_PROJECT/./simWorkspace/AxiLite4CDMASpread/") + name + ".dat").c_str());
      #endif
    }
