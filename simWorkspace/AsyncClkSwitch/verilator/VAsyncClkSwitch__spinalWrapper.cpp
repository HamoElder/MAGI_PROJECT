...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.clk_in_0 );
      signalAccess[1] = new CDataSignalAccess( top.clk_in_1 );
      signalAccess[2] = new CDataSignalAccess( top.clk_rstn );
      signalAccess[3] = new CDataSignalAccess( top.select_1 );
      signalAccess[4] = new CDataSignalAccess( top.clk_out );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("/mnt/BackUp/IdeaProjects/MAGI_PROJECT/./simWorkspace/AsyncClkSwitch/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/mnt/BackUp/IdeaProjects/MAGI_PROJECT/./simWorkspace/AsyncClkSwitch/") + name + ".dat").c_str());
      #endif
    }
