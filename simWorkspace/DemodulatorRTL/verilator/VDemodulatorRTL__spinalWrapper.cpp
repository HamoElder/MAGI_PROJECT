...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.select_1 );
      signalAccess[1] = new CDataSignalAccess( top.data_flow_mod_iq_valid );
      signalAccess[2] = new SDataSignalAccess( top.data_flow_mod_iq_payload_cha_i );
      signalAccess[3] = new SDataSignalAccess( top.data_flow_mod_iq_payload_cha_q );
      signalAccess[4] = new CDataSignalAccess( top.data_flow_unit_data_valid );
      signalAccess[5] = new SDataSignalAccess( top.data_flow_unit_data_payload );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/DemodulatorRTL/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/DemodulatorRTL/") + name + ".dat").c_str());
      #endif
    }
