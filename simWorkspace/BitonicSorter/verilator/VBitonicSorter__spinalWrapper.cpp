...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[1] = new CDataSignalAccess( top.raw_data_payload_0 );
      signalAccess[2] = new CDataSignalAccess( top.raw_data_payload_1 );
      signalAccess[3] = new CDataSignalAccess( top.raw_data_payload_2 );
      signalAccess[4] = new CDataSignalAccess( top.raw_data_payload_3 );
      signalAccess[5] = new CDataSignalAccess( top.raw_data_payload_4 );
      signalAccess[6] = new CDataSignalAccess( top.raw_data_payload_5 );
      signalAccess[7] = new CDataSignalAccess( top.raw_data_payload_6 );
      signalAccess[8] = new CDataSignalAccess( top.raw_data_payload_7 );
      signalAccess[9] = new CDataSignalAccess( top.raw_data_payload_8 );
      signalAccess[10] = new CDataSignalAccess( top.raw_data_payload_9 );
      signalAccess[11] = new CDataSignalAccess( top.raw_data_payload_10 );
      signalAccess[12] = new CDataSignalAccess( top.raw_data_payload_11 );
      signalAccess[13] = new CDataSignalAccess( top.raw_data_payload_12 );
      signalAccess[14] = new CDataSignalAccess( top.raw_data_payload_13 );
      signalAccess[15] = new CDataSignalAccess( top.raw_data_payload_14 );
      signalAccess[16] = new CDataSignalAccess( top.raw_data_payload_15 );
      signalAccess[17] = new CDataSignalAccess( top.ascending_order );
      signalAccess[18] = new CDataSignalAccess( top.sorted_data_valid );
      signalAccess[19] = new CDataSignalAccess( top.sorted_data_payload_0_data );
      signalAccess[20] = new CDataSignalAccess( top.sorted_data_payload_1_data );
      signalAccess[21] = new CDataSignalAccess( top.sorted_data_payload_2_data );
      signalAccess[22] = new CDataSignalAccess( top.sorted_data_payload_3_data );
      signalAccess[23] = new CDataSignalAccess( top.sorted_data_payload_4_data );
      signalAccess[24] = new CDataSignalAccess( top.sorted_data_payload_5_data );
      signalAccess[25] = new CDataSignalAccess( top.sorted_data_payload_6_data );
      signalAccess[26] = new CDataSignalAccess( top.sorted_data_payload_7_data );
      signalAccess[27] = new CDataSignalAccess( top.sorted_data_payload_8_data );
      signalAccess[28] = new CDataSignalAccess( top.sorted_data_payload_9_data );
      signalAccess[29] = new CDataSignalAccess( top.sorted_data_payload_10_data );
      signalAccess[30] = new CDataSignalAccess( top.sorted_data_payload_11_data );
      signalAccess[31] = new CDataSignalAccess( top.sorted_data_payload_12_data );
      signalAccess[32] = new CDataSignalAccess( top.sorted_data_payload_13_data );
      signalAccess[33] = new CDataSignalAccess( top.sorted_data_payload_14_data );
      signalAccess[34] = new CDataSignalAccess( top.sorted_data_payload_15_data );
      signalAccess[35] = new CDataSignalAccess( top.clk );
      signalAccess[36] = new CDataSignalAccess( top.reset );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/BitonicSorter/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/BitonicSorter/") + name + ".dat").c_str());
      #endif
    }
