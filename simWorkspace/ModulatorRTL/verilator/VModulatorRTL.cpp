...
VL_INLINE_OPT void VModulatorRTL::_sequent__TOP__1(VModulatorRTL__Syms* __restrict vlSymsp) {
    ...
    if ((0U != (IData)(vlTOPp->w_en))) {
        vlTOPp->ModulatorRTL__DOT__mod_1__DOT___zz_code_map_port1 
            ...
            [vlTOPp->ModulatorRTL__DOT__mod_1__DOT__unit_data];
    }
    if ((1U != (IData)(vlTOPp->w_en))) {
        vlTOPp->ModulatorRTL__DOT__mod_2__DOT___zz_code_map_port1 
            = vlTOPp->ModulatorRTL__DOT__mod_2__DOT__code_map
            [((0x78U & ((IData)(vlTOPp->ModulatorRTL__DOT__mod_2__DOT__unit_data) 
...
VL_INLINE_OPT void VModulatorRTL::_sequent__TOP__2(VModulatorRTL__Syms* __restrict vlSymsp) {
    ...
    // Body
    __Vdly__ModulatorRTL__DOT__mod_2__DOT___zz_data_in_ready 
        = vlTOPp->ModulatorRTL__DOT__mod_2__DOT___zz_data_in_ready;
    vlTOPp->ModulatorRTL__DOT__mod_2__DOT__unit_data 
        = ((IData)(vlTOPp->reset) ? 0U : ((4U != (IData)(vlTOPp->select_1))
                                           ? 0U : (0x7fU 
                                                   & (IData)(vlTOPp->data_flow_unit_data_payload))));
    vlTOPp->ModulatorRTL__DOT__mod_1__DOT__unit_data 
        = ((IData)(vlTOPp->reset) ? 0U : ((3U != (IData)(vlTOPp->select_1))
                                           ? 0U : (IData)(vlTOPp->data_flow_unit_data_payload)));
    vlTOPp->ModulatorRTL__DOT__mQAM_Modulator_Extension_mod__DOT__unit_data 
        = ((IData)(vlTOPp->reset) ? 0U : ((2U != (IData)(vlTOPp->select_1))
                                           ? 0U : (0xfU 
                                                   & (IData)(vlTOPp->data_flow_unit_data_payload))));
    vlTOPp->ModulatorRTL__DOT__mPSK_Modulator_Extension_mod__DOT__unit_data 
    ...
    vlTOPp->ModulatorRTL__DOT__mPSK_Modulator_Extension_mod__DOT__unit_valid 
        = ((~ (IData)(vlTOPp->reset)) & ((0U == (IData)(vlTOPp->select_1)) 
                                         & (IData)(vlTOPp->data_flow_unit_data_valid)));
    vlTOPp->ModulatorRTL__DOT__mPSK_Modulator_Extension_mod_1__DOT__unit_data 
    ...
    if (vlTOPp->reset) {
        __Vdly__ModulatorRTL__DOT__mod_2__DOT___zz_data_in_ready = 0U;
    } else {
        if (vlTOPp->ModulatorRTL__DOT__mod_2__DOT__when_lookUpMod_l57) {
            __Vdly__ModulatorRTL__DOT__mod_2__DOT___zz_data_in_ready 
                = (7U & ((IData)(1U) + (IData)(vlTOPp->ModulatorRTL__DOT__mod_2__DOT___zz_data_in_ready)));
        } else {
            if (vlTOPp->ModulatorRTL__DOT__mod_2__DOT__when_lookUpMod_l60) {
                __Vdly__ModulatorRTL__DOT__mod_2__DOT___zz_data_in_ready 
    ...
    vlTOPp->ModulatorRTL__DOT__mPSK_Modulator_Extension_mod_1__DOT___zz___05Fzz_mod_iq_0 
        = ((0U == (IData)(vlTOPp->ModulatorRTL__DOT__mPSK_Modulator_Extension_mod_1__DOT__unit_data))
            ? 0xa59a59U : ((1U == (IData)(vlTOPp->ModulatorRTL__DOT__mPSK_Modulator_Extension_mod_1__DOT__unit_data))
                            ? 0xa595a7U : ((2U == (IData)(vlTOPp->ModulatorRTL__DOT__mPSK_Modulator_Extension_mod_1__DOT__unit_data))
                                            ? 0x5a7a59U
                                            : 0x5a75a7U)));
    vlTOPp->ModulatorRTL__DOT__mod_2__DOT___zz___05Fzz_data_in_ready 
        = (7U & ((IData)(1U) + (IData)(vlTOPp->ModulatorRTL__DOT__mod_2__DOT___zz_data_in_ready)));
    vlTOPp->ModulatorRTL__DOT__mod_2__DOT__when_lookUpMod_l60 
...
VL_INLINE_OPT void VModulatorRTL::_combo__TOP__4(VModulatorRTL__Syms* __restrict vlSymsp) {
    ...
    vlTOPp->ModulatorRTL__DOT__mod_1__DOT__when_lookUpMod_l84 
        = ((IData)(vlTOPp->ModulatorRTL__DOT__mod_1__DOT__unit_valid) 
           & (0U != (IData)(vlTOPp->w_en)));
    vlTOPp->ModulatorRTL__DOT__mod_2__DOT__when_lookUpMod_l69 
        = (((IData)(vlTOPp->ModulatorRTL__DOT__mod_2__DOT__unit_valid) 
            | (0U != (IData)(vlTOPp->ModulatorRTL__DOT__mod_2__DOT___zz_data_in_ready))) 
           & (1U != (IData)(vlTOPp->w_en)));
    vlTOPp->ModulatorRTL__DOT__mod_2__DOT__when_lookUpMod_l57 
    ...
    vlTOPp->data_flow_mod_iq_payload_cha_i = (0xfffU 
                                              & ((4U 
                                                  & (IData)(vlTOPp->select_1))
                                                  ? 
                                                 ((IData)(vlTOPp->ModulatorRTL__DOT__mod_2__DOT__when_lookUpMod_l69)
                                                  ...
                                                  ((1U 
                                                   ...
                                                   ((IData)(vlTOPp->ModulatorRTL__DOT__mPSK_Modulator_Extension_mod__DOT__unit_valid)
                                                    ...
                                                    (((IData)(vlTOPp->ModulatorRTL__DOT__mPSK_Modulator_Extension_mod__DOT__unit_data)
                                                     ...
                                                     >> 0xcU)
                                                     : 0U)))));
    vlTOPp->data_flow_mod_iq_payload_cha_q = (0xfffU 
                                              & ((4U 
                                                  & (IData)(vlTOPp->select_1))
                                                  ? 
                                                 ((IData)(vlTOPp->ModulatorRTL__DOT__mod_2__DOT__when_lookUpMod_l69)
