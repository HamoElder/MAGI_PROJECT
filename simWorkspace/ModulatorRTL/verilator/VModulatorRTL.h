...
VL_MODULE(VModulatorRTL) {
  public:
    ...
    VL_IN8(data_flow_unit_data_payload,7,0);
    VL_OUT8(data_flow_mod_iq_valid,0,0);
    VL_IN8(w_en,1,0);
    VL_IN8(select_1,2,0);
    VL_OUT16(data_flow_mod_iq_payload_cha_i,11,0);
    VL_OUT16(data_flow_mod_iq_payload_cha_q,11,0);
    VL_IN(w_addr,31,0);
    VL_IN(w_data,31,0);
    ...
    CData/*0:0*/ ModulatorRTL__DOT__mPSK_Modulator_Extension_mod__DOT__unit_data;
    CData/*0:0*/ ModulatorRTL__DOT__mPSK_Modulator_Extension_mod__DOT__unit_valid;
    CData/*1:0*/ ModulatorRTL__DOT__mPSK_Modulator_Extension_mod_1__DOT__unit_data;
    CData/*0:0*/ ModulatorRTL__DOT__mPSK_Modulator_Extension_mod_1__DOT__unit_valid;
    CData/*3:0*/ ModulatorRTL__DOT__mQAM_Modulator_Extension_mod__DOT__unit_data;
    CData/*0:0*/ ModulatorRTL__DOT__mQAM_Modulator_Extension_mod__DOT__unit_valid;
    CData/*7:0*/ ModulatorRTL__DOT__mod_1__DOT__unit_data;
    CData/*0:0*/ ModulatorRTL__DOT__mod_1__DOT__unit_valid;
    CData/*0:0*/ ModulatorRTL__DOT__mod_1__DOT__when_lookUpMod_l84;
    CData/*2:0*/ ModulatorRTL__DOT__mod_2__DOT___zz___05Fzz_data_in_ready;
    CData/*6:0*/ ModulatorRTL__DOT__mod_2__DOT__unit_data;
    CData/*0:0*/ ModulatorRTL__DOT__mod_2__DOT__unit_valid;
    CData/*2:0*/ ModulatorRTL__DOT__mod_2__DOT___zz_data_in_ready;
    CData/*0:0*/ ModulatorRTL__DOT__mod_2__DOT__when_lookUpMod_l57;
    CData/*0:0*/ ModulatorRTL__DOT__mod_2__DOT__when_lookUpMod_l60;
    CData/*0:0*/ ModulatorRTL__DOT__mod_2__DOT__when_lookUpMod_l69;
