...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[4] = new IDataSignalAccess( top.data_flow_unit_data_payload );
      signalAccess[5] = new CDataSignalAccess( top.w_en );
      signalAccess[6] = new SDataSignalAccess( top.w_addr );
      signalAccess[7] = new IDataSignalAccess( top.w_data );
      signalAccess[8] = new CDataSignalAccess( top.select_1 );
