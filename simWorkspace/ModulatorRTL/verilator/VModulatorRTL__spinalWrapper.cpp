...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[1] = new SDataSignalAccess( top.data_flow_mod_iq_payload_cha_i );
      signalAccess[2] = new SDataSignalAccess( top.data_flow_mod_iq_payload_cha_q );
      signalAccess[3] = new CDataSignalAccess( top.data_flow_unit_data_valid );
      signalAccess[4] = new CDataSignalAccess( top.data_flow_unit_data_payload );
      signalAccess[5] = new CDataSignalAccess( top.w_en );
      signalAccess[6] = new IDataSignalAccess( top.w_addr );
      signalAccess[7] = new IDataSignalAccess( top.w_data );
      signalAccess[8] = new IDataSignalAccess( top.cnt_limit );
      signalAccess[9] = new CDataSignalAccess( top.select_1 );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/ModulatorRTL/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/ModulatorRTL/") + name + ".dat").c_str());
      #endif
    }
