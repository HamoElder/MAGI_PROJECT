...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.data_flow_mod_iq_valid );
      signalAccess[1] = new CDataSignalAccess( top.data_flow_mod_iq_payload_last );
      signalAccess[2] = new SDataSignalAccess( top.data_flow_mod_iq_payload_fragment_cha_i );
      signalAccess[3] = new SDataSignalAccess( top.data_flow_mod_iq_payload_fragment_cha_q );
      signalAccess[4] = new CDataSignalAccess( top.data_flow_unit_data_valid );
      signalAccess[5] = new CDataSignalAccess( top.data_flow_unit_data_payload_last );
      signalAccess[6] = new CDataSignalAccess( top.data_flow_unit_data_payload_fragment );
      signalAccess[7] = new CDataSignalAccess( top.w_en );
      signalAccess[8] = new IDataSignalAccess( top.w_addr );
      signalAccess[9] = new IDataSignalAccess( top.w_data );
      signalAccess[10] = new IDataSignalAccess( top.cnt_limit );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/ModulatorRTL/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/ModulatorRTL/") + name + ".dat").c_str());
      #endif
    }
