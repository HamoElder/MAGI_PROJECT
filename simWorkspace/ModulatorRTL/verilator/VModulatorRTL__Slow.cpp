...
void VModulatorRTL::_ctor_var_reset() {
    ...
    ModulatorRTL__DOT__mPSK_Modulator_Extension_mod__DOT__unit_data = VL_RAND_RESET_I(1);
    ...
    ModulatorRTL__DOT__mPSK_Modulator_Extension_mod_1__DOT__unit_data = VL_RAND_RESET_I(2);
    ModulatorRTL__DOT__mPSK_Modulator_Extension_mod_1__DOT__unit_valid = VL_RAND_RESET_I(1);
    ModulatorRTL__DOT__mQAM_Modulator_Extension_mod__DOT__unit_data = VL_RAND_RESET_I(4);
    ...
    ModulatorRTL__DOT__mod_1__DOT__unit_data = VL_RAND_RESET_I(8);
    ModulatorRTL__DOT__mod_1__DOT__unit_valid = VL_RAND_RESET_I(1);
    ModulatorRTL__DOT__mod_1__DOT__when_lookUpMod_l84 = VL_RAND_RESET_I(1);
    ...
    ModulatorRTL__DOT__mod_2__DOT__unit_data = VL_RAND_RESET_I(7);
    ...
    ModulatorRTL__DOT__mod_2__DOT__when_lookUpMod_l57 = VL_RAND_RESET_I(1);
    ModulatorRTL__DOT__mod_2__DOT__when_lookUpMod_l60 = VL_RAND_RESET_I(1);
    ModulatorRTL__DOT__mod_2__DOT__when_lookUpMod_l69 = VL_RAND_RESET_I(1);
