...
#    make -f VCICIntegrator.mk

default: VCICIntegrator
...
VM_PREFIX = VCICIntegrator
# Module prefix (from --prefix)
VM_MODPREFIX = VCICIntegrator
...
include VCICIntegrator_classes.mk
...
VCICIntegrator__spinalWrapper.o: verilator/VCICIntegrator__spinalWrapper.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
VCICIntegrator: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
