...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[1] = new SDataSignalAccess( top.mod_iq_payload_cha_i );
      signalAccess[2] = new SDataSignalAccess( top.mod_iq_payload_cha_q );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/mFSKMod/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/mFSKMod/") + name + ".dat").c_str());
      #endif
    }
