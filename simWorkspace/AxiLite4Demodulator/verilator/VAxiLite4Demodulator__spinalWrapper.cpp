...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[20] = new SDataSignalAccess( top.mod_iq_payload_cha_i );
      signalAccess[21] = new SDataSignalAccess( top.mod_iq_payload_cha_q );
      signalAccess[22] = new CDataSignalAccess( top.base_data_valid );
      signalAccess[23] = new IDataSignalAccess( top.base_data_payload );
      signalAccess[24] = new CDataSignalAccess( top.rf_clk );
      signalAccess[25] = new CDataSignalAccess( top.rf_resetn );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/AxiLite4Demodulator/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/AxiLite4Demodulator/") + name + ".dat").c_str());
      #endif
    }
