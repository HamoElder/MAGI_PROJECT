...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[3] = new CDataSignalAccess( top.phiCorrect_valid );
      signalAccess[4] = new IDataSignalAccess( top.phiCorrect_payload );
      signalAccess[5] = new CDataSignalAccess( top.rotated_data_valid );
      signalAccess[6] = new SDataSignalAccess( top.rotated_data_payload_cha_i );
      signalAccess[7] = new SDataSignalAccess( top.rotated_data_payload_cha_q );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/PhaseRotator/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/PhaseRotator/") + name + ".dat").c_str());
      #endif
    }
