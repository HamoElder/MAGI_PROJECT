...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[4] = new CDataSignalAccess( top.rotated_data_ready );
      signalAccess[5] = new SDataSignalAccess( top.rotated_data_payload_cha_i );
      signalAccess[6] = new SDataSignalAccess( top.rotated_data_payload_cha_q );
      signalAccess[7] = new SDataSignalAccess( top.phiCorrect );
