...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[19] = new CDataSignalAccess( top.data_0_valid );
      signalAccess[20] = new CDataSignalAccess( top.data_0_ready );
      signalAccess[21] = new IDataSignalAccess( top.data_0_payload );
      signalAccess[22] = new CDataSignalAccess( top.data_1_valid );
      signalAccess[23] = new CDataSignalAccess( top.data_1_ready );
      signalAccess[24] = new IDataSignalAccess( top.data_1_payload );
      signalAccess[25] = new CDataSignalAccess( top.data_2_valid );
      signalAccess[26] = new CDataSignalAccess( top.data_2_ready );
      signalAccess[27] = new IDataSignalAccess( top.data_2_payload );
      signalAccess[28] = new CDataSignalAccess( top.data_3_valid );
      signalAccess[29] = new CDataSignalAccess( top.data_3_ready );
      signalAccess[30] = new IDataSignalAccess( top.data_3_payload );
      signalAccess[31] = new CDataSignalAccess( top.rf_clk );
      signalAccess[32] = new CDataSignalAccess( top.rf_resetn );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/AxiLite4DDS/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/AxiLite4DDS/") + name + ".dat").c_str());
      #endif
    }
