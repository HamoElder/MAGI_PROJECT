...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[20] = new IDataSignalAccess( top.data_0_payload );
      signalAccess[21] = new CDataSignalAccess( top.data_1_valid );
      signalAccess[22] = new IDataSignalAccess( top.data_1_payload );
      signalAccess[23] = new CDataSignalAccess( top.phase_0_valid );
      signalAccess[24] = new SDataSignalAccess( top.phase_0_payload );
      signalAccess[25] = new CDataSignalAccess( top.phase_1_valid );
      signalAccess[26] = new SDataSignalAccess( top.phase_1_payload );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/AxiLite4DDS/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/AxiLite4DDS/") + name + ".dat").c_str());
      #endif
    }
