...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[3] = new CDataSignalAccess( top.power_result_valid );
      signalAccess[4] = new SDataSignalAccess( top.power_result_payload_cha_i );
      signalAccess[5] = new SDataSignalAccess( top.power_result_payload_cha_q );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/PowerMeter/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/PowerMeter/") + name + ".dat").c_str());
      #endif
    }
