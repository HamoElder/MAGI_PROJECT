...
void VBDMAm2s::traceInitThis__1(VBDMAm2s__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        vcdp->declBit(c+2185,"dma_ar_valid", false,-1);
        vcdp->declBit(c+2193,"dma_ar_ready", false,-1);
        vcdp->declBus(c+2201,"dma_ar_payload_addr", false,-1, 31,0);
        vcdp->declBus(c+2209,"dma_ar_payload_id", false,-1, 3,0);
        vcdp->declBus(c+2217,"dma_ar_payload_len", false,-1, 7,0);
        vcdp->declBus(c+2225,"dma_ar_payload_size", false,-1, 2,0);
        vcdp->declBus(c+2233,"dma_ar_payload_burst", false,-1, 1,0);
        vcdp->declBit(c+2241,"dma_r_valid", false,-1);
        vcdp->declBit(c+2249,"dma_r_ready", false,-1);
        vcdp->declBus(c+2257,"dma_r_payload_data", false,-1, 31,0);
        vcdp->declBus(c+2265,"dma_r_payload_id", false,-1, 3,0);
        vcdp->declBus(c+2273,"dma_r_payload_resp", false,-1, 1,0);
        vcdp->declBit(c+2281,"dma_r_payload_last", false,-1);
        vcdp->declBit(c+2289,"m2s_data_stream_valid", false,-1);
        vcdp->declBit(c+2297,"m2s_data_stream_ready", false,-1);
        vcdp->declBus(c+2305,"m2s_data_stream_payload_data", false,-1, 31,0);
        vcdp->declBus(c+2313,"m2s_data_stream_payload_id", false,-1, 3,0);
        vcdp->declBus(c+2321,"m2s_data_stream_payload_strb", false,-1, 3,0);
        vcdp->declBus(c+2329,"m2s_data_stream_payload_keep_", false,-1, 3,0);
        vcdp->declBit(c+2337,"m2s_data_stream_payload_last", false,-1);
        vcdp->declBus(c+2345,"m2s_state", false,-1, 1,0);
        vcdp->declBit(c+2353,"m2s_cch_valid", false,-1);
        vcdp->declBit(c+2361,"m2s_cch_ready", false,-1);
        vcdp->declBus(c+2369,"m2s_cch_payload_desc_start_addr", false,-1, 31,0);
        vcdp->declBus(c+2377,"m2s_cch_payload_desc_total_bytes", false,-1, 29,0);
        vcdp->declBus(c+2385,"m2s_cch_payload_desc_burst", false,-1, 1,0);
        vcdp->declBus(c+2393,"m2s_cch_payload_desc_id", false,-1, 3,0);
        vcdp->declBit(c+2401,"m2s_cch_payload_desc_reset", false,-1);
        vcdp->declBit(c+2409,"m2s_intr", false,-1);
        vcdp->declBit(c+2417,"clk", false,-1);
        vcdp->declBit(c+2425,"reset", false,-1);
        vcdp->declBit(c+2185,"BDMAm2s dma_ar_valid", false,-1);
        vcdp->declBit(c+2193,"BDMAm2s dma_ar_ready", false,-1);
        vcdp->declBus(c+2201,"BDMAm2s dma_ar_payload_addr", false,-1, 31,0);
        vcdp->declBus(c+2209,"BDMAm2s dma_ar_payload_id", false,-1, 3,0);
        vcdp->declBus(c+2217,"BDMAm2s dma_ar_payload_len", false,-1, 7,0);
        vcdp->declBus(c+2225,"BDMAm2s dma_ar_payload_size", false,-1, 2,0);
        vcdp->declBus(c+2233,"BDMAm2s dma_ar_payload_burst", false,-1, 1,0);
        vcdp->declBit(c+2241,"BDMAm2s dma_r_valid", false,-1);
        vcdp->declBit(c+2249,"BDMAm2s dma_r_ready", false,-1);
        vcdp->declBus(c+2257,"BDMAm2s dma_r_payload_data", false,-1, 31,0);
        vcdp->declBus(c+2265,"BDMAm2s dma_r_payload_id", false,-1, 3,0);
        vcdp->declBus(c+2273,"BDMAm2s dma_r_payload_resp", false,-1, 1,0);
        vcdp->declBit(c+2281,"BDMAm2s dma_r_payload_last", false,-1);
        vcdp->declBit(c+2289,"BDMAm2s m2s_data_stream_valid", false,-1);
        vcdp->declBit(c+2297,"BDMAm2s m2s_data_stream_ready", false,-1);
        vcdp->declBus(c+2305,"BDMAm2s m2s_data_stream_payload_data", false,-1, 31,0);
        vcdp->declBus(c+2313,"BDMAm2s m2s_data_stream_payload_id", false,-1, 3,0);
        vcdp->declBus(c+2321,"BDMAm2s m2s_data_stream_payload_strb", false,-1, 3,0);
        vcdp->declBus(c+2329,"BDMAm2s m2s_data_stream_payload_keep_", false,-1, 3,0);
        vcdp->declBit(c+2337,"BDMAm2s m2s_data_stream_payload_last", false,-1);
        vcdp->declBus(c+2345,"BDMAm2s m2s_state", false,-1, 1,0);
        vcdp->declBit(c+2353,"BDMAm2s m2s_cch_valid", false,-1);
        vcdp->declBit(c+2361,"BDMAm2s m2s_cch_ready", false,-1);
        vcdp->declBus(c+2369,"BDMAm2s m2s_cch_payload_desc_start_addr", false,-1, 31,0);
        vcdp->declBus(c+2377,"BDMAm2s m2s_cch_payload_desc_total_bytes", false,-1, 29,0);
        vcdp->declBus(c+2385,"BDMAm2s m2s_cch_payload_desc_burst", false,-1, 1,0);
        vcdp->declBus(c+2393,"BDMAm2s m2s_cch_payload_desc_id", false,-1, 3,0);
        vcdp->declBit(c+2401,"BDMAm2s m2s_cch_payload_desc_reset", false,-1);
        vcdp->declBit(c+2409,"BDMAm2s m2s_intr", false,-1);
        vcdp->declBit(c+2417,"BDMAm2s clk", false,-1);
        vcdp->declBit(c+2425,"BDMAm2s reset", false,-1);
        vcdp->declBit(c+2433,"BDMAm2s m2s_ar_fifo_io_pop_ready", false,-1);
        ...
        vcdp->declBus(c+81,"BDMAm2s m2s_data_fifo_io_occupancy", false,-1, 3,0);
        vcdp->declBus(c+89,"BDMAm2s m2s_data_fifo_io_availability", false,-1, 3,0);
        ...
        vcdp->declBit(c+2441,"BDMAm2s when_BDMAm2s_l156", false,-1);
        vcdp->declBit(c+2449,"BDMAm2s dma_ar_fire", false,-1);
        vcdp->declBus(c+2489,"BDMAm2s keep_strb_full", false,-1, 3,0);
        ...
        vcdp->declBus(c+2497,"BDMAm2s m2s_axis_low_bytes", false,-1, 1,0);
        ...
        vcdp->declBit(c+2457,"BDMAm2s m2s_data_fifo_io_pop_fire", false,-1);
        vcdp->declBit(c+2465,"BDMAm2s when_BDMAm2s_l344", false,-1);
        vcdp->declQuad(c+2473,"BDMAm2s m2s_state_string", false,-1, 55,0);
        ...
        vcdp->declBus(c+2505,"BDMAm2s m2s_ar_fifo io_push_payload_size", false,-1, 2,0);
        ...
        vcdp->declBit(c+2433,"BDMAm2s m2s_ar_fifo io_pop_ready", false,-1);
        ...
        vcdp->declBit(c+2513,"BDMAm2s m2s_ar_fifo io_flush", false,-1);
        ...
        vcdp->declBit(c+2417,"BDMAm2s m2s_ar_fifo clk", false,-1);
        vcdp->declBit(c+2425,"BDMAm2s m2s_ar_fifo reset", false,-1);
        vcdp->declBit(c+249,"BDMAm2s m2s_ar_fifo logic_pushPtr_willIncrement", false,-1);
        vcdp->declBit(c+2513,"BDMAm2s m2s_ar_fifo logic_pushPtr_willClear", false,-1);
        ...
        vcdp->declBit(c+2513,"BDMAm2s m2s_ar_fifo logic_popPtr_willClear", false,-1);
        ...
        vcdp->declBit(c+2449,"BDMAm2s m2s_trans_bytes_fifo io_pop_ready", false,-1);
        vcdp->declBus(c+881,"BDMAm2s m2s_trans_bytes_fifo io_pop_payload", false,-1, 29,0);
        vcdp->declBit(c+2513,"BDMAm2s m2s_trans_bytes_fifo io_flush", false,-1);
        ...
        vcdp->declBit(c+2417,"BDMAm2s m2s_trans_bytes_fifo clk", false,-1);
        vcdp->declBit(c+2425,"BDMAm2s m2s_trans_bytes_fifo reset", false,-1);
        vcdp->declBit(c+297,"BDMAm2s m2s_trans_bytes_fifo logic_pushPtr_willIncrement", false,-1);
        vcdp->declBit(c+2513,"BDMAm2s m2s_trans_bytes_fifo logic_pushPtr_willClear", false,-1);
        ...
        vcdp->declBit(c+2513,"BDMAm2s m2s_trans_bytes_fifo logic_popPtr_willClear", false,-1);
        ...
        vcdp->declBit(c+2297,"BDMAm2s m2s_data_fifo io_pop_ready", false,-1);
        ...
        vcdp->declBit(c+2513,"BDMAm2s m2s_data_fifo io_flush", false,-1);
        vcdp->declBus(c+81,"BDMAm2s m2s_data_fifo io_occupancy", false,-1, 3,0);
        vcdp->declBus(c+89,"BDMAm2s m2s_data_fifo io_availability", false,-1, 3,0);
        vcdp->declBit(c+2417,"BDMAm2s m2s_data_fifo clk", false,-1);
        vcdp->declBit(c+2425,"BDMAm2s m2s_data_fifo reset", false,-1);
        vcdp->declBit(c+353,"BDMAm2s m2s_data_fifo logic_pushPtr_willIncrement", false,-1);
        vcdp->declBit(c+2513,"BDMAm2s m2s_data_fifo logic_pushPtr_willClear", false,-1);
        vcdp->declBus(c+361,"BDMAm2s m2s_data_fifo logic_pushPtr_valueNext", false,-1, 2,0);
        vcdp->declBus(c+1689,"BDMAm2s m2s_data_fifo logic_pushPtr_value", false,-1, 2,0);
        ...
        vcdp->declBit(c+2513,"BDMAm2s m2s_data_fifo logic_popPtr_willClear", false,-1);
        vcdp->declBus(c+817,"BDMAm2s m2s_data_fifo logic_popPtr_valueNext", false,-1, 2,0);
        vcdp->declBus(c+1705,"BDMAm2s m2s_data_fifo logic_popPtr_value", false,-1, 2,0);
        ...
        vcdp->declBus(c+1729,"BDMAm2s m2s_data_fifo logic_ptrDif", false,-1, 2,0);
        {int i; for (i=0; i<8; i++) {
        ...
        vcdp->declBit(c+2513,"BDMAm2s len_pending_fifo io_flush", false,-1);
        ...
        vcdp->declBit(c+2417,"BDMAm2s len_pending_fifo clk", false,-1);
        vcdp->declBit(c+2425,"BDMAm2s len_pending_fifo reset", false,-1);
        vcdp->declBit(c+409,"BDMAm2s len_pending_fifo logic_pushPtr_willIncrement", false,-1);
        vcdp->declBit(c+2513,"BDMAm2s len_pending_fifo logic_pushPtr_willClear", false,-1);
        ...
        vcdp->declBit(c+2513,"BDMAm2s len_pending_fifo logic_popPtr_willClear", false,-1);
        ...
        vcdp->declBit(c+2513,"BDMAm2s id_pending_fifo io_flush", false,-1);
        ...
        vcdp->declBit(c+2417,"BDMAm2s id_pending_fifo clk", false,-1);
        vcdp->declBit(c+2425,"BDMAm2s id_pending_fifo reset", false,-1);
        vcdp->declBit(c+505,"BDMAm2s id_pending_fifo logic_pushPtr_willIncrement", false,-1);
        vcdp->declBit(c+2513,"BDMAm2s id_pending_fifo logic_pushPtr_willClear", false,-1);
        ...
        vcdp->declBit(c+2513,"BDMAm2s id_pending_fifo logic_popPtr_willClear", false,-1);
        ...
        vcdp->declBit(c+2513,"BDMAm2s trans_pending_fifo io_flush", false,-1);
        ...
        vcdp->declBit(c+2417,"BDMAm2s trans_pending_fifo clk", false,-1);
        vcdp->declBit(c+2425,"BDMAm2s trans_pending_fifo reset", false,-1);
        vcdp->declBit(c+601,"BDMAm2s trans_pending_fifo logic_pushPtr_willIncrement", false,-1);
        vcdp->declBit(c+2513,"BDMAm2s trans_pending_fifo logic_pushPtr_willClear", false,-1);
        ...
        vcdp->declBit(c+2513,"BDMAm2s trans_pending_fifo logic_popPtr_willClear", false,-1);
        ...
        {int i; for (i=0; i<12; i++) {
                vcdp->declBus(c+2089+i*1,"BDMAm2s trans_pending_fifo logic_ram", true,(i+0), 29,0);}}
    }
}
...
void VBDMAm2s::traceFullThis__1(VBDMAm2s__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->fullBus(c+361,(vlTOPp->BDMAm2s__DOT__m2s_data_fifo__DOT__logic_pushPtr_valueNext),3);
        vcdp->fullBit(c+369,(((7U == (IData)(vlTOPp->BDMAm2s__DOT__m2s_data_fifo__DOT__logic_pushPtr_value)) 
        ...
        vcdp->fullBit(c+721,(((7U == (IData)(vlTOPp->BDMAm2s__DOT__m2s_data_fifo__DOT__logic_popPtr_value)) 
        ...
        vcdp->fullBus(c+817,(vlTOPp->BDMAm2s__DOT__m2s_data_fifo__DOT__logic_popPtr_valueNext),3);
...
void VBDMAm2s::traceFullThis__7(VBDMAm2s__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->fullBus(c+1689,(vlTOPp->BDMAm2s__DOT__m2s_data_fifo__DOT__logic_pushPtr_value),3);
        vcdp->fullBit(c+1697,((7U == (IData)(vlTOPp->BDMAm2s__DOT__m2s_data_fifo__DOT__logic_pushPtr_value))));
        vcdp->fullBus(c+1705,(vlTOPp->BDMAm2s__DOT__m2s_data_fifo__DOT__logic_popPtr_value),3);
        vcdp->fullBit(c+1713,((7U == (IData)(vlTOPp->BDMAm2s__DOT__m2s_data_fifo__DOT__logic_popPtr_value))));
        vcdp->fullBit(c+1721,(vlTOPp->BDMAm2s__DOT__m2s_data_fifo__DOT__logic_risingOccupancy));
        vcdp->fullBus(c+1729,((7U & ((IData)(vlTOPp->BDMAm2s__DOT__m2s_data_fifo__DOT__logic_pushPtr_value) 
        ...
        vcdp->fullBus(c+2089,(vlTOPp->BDMAm2s__DOT__trans_pending_fifo__DOT__logic_ram[0]),30);
        vcdp->fullBus(c+2090,(vlTOPp->BDMAm2s__DOT__trans_pending_fifo__DOT__logic_ram[1]),30);
        vcdp->fullBus(c+2091,(vlTOPp->BDMAm2s__DOT__trans_pending_fifo__DOT__logic_ram[2]),30);
        vcdp->fullBus(c+2092,(vlTOPp->BDMAm2s__DOT__trans_pending_fifo__DOT__logic_ram[3]),30);
        vcdp->fullBus(c+2093,(vlTOPp->BDMAm2s__DOT__trans_pending_fifo__DOT__logic_ram[4]),30);
        vcdp->fullBus(c+2094,(vlTOPp->BDMAm2s__DOT__trans_pending_fifo__DOT__logic_ram[5]),30);
        vcdp->fullBus(c+2095,(vlTOPp->BDMAm2s__DOT__trans_pending_fifo__DOT__logic_ram[6]),30);
        vcdp->fullBus(c+2096,(vlTOPp->BDMAm2s__DOT__trans_pending_fifo__DOT__logic_ram[7]),30);
        vcdp->fullBus(c+2097,(vlTOPp->BDMAm2s__DOT__trans_pending_fifo__DOT__logic_ram[8]),30);
        vcdp->fullBus(c+2098,(vlTOPp->BDMAm2s__DOT__trans_pending_fifo__DOT__logic_ram[9]),30);
        vcdp->fullBus(c+2099,(vlTOPp->BDMAm2s__DOT__trans_pending_fifo__DOT__logic_ram[10]),30);
        vcdp->fullBus(c+2100,(vlTOPp->BDMAm2s__DOT__trans_pending_fifo__DOT__logic_ram[11]),30);
        vcdp->fullBit(c+2185,(vlTOPp->dma_ar_valid));
        vcdp->fullBit(c+2193,(vlTOPp->dma_ar_ready));
        vcdp->fullBus(c+2201,(vlTOPp->dma_ar_payload_addr),32);
        vcdp->fullBus(c+2209,(vlTOPp->dma_ar_payload_id),4);
        vcdp->fullBus(c+2217,(vlTOPp->dma_ar_payload_len),8);
        vcdp->fullBus(c+2225,(vlTOPp->dma_ar_payload_size),3);
        vcdp->fullBus(c+2233,(vlTOPp->dma_ar_payload_burst),2);
        vcdp->fullBit(c+2241,(vlTOPp->dma_r_valid));
        vcdp->fullBit(c+2249,(vlTOPp->dma_r_ready));
        vcdp->fullBus(c+2257,(vlTOPp->dma_r_payload_data),32);
        vcdp->fullBus(c+2265,(vlTOPp->dma_r_payload_id),4);
        vcdp->fullBus(c+2273,(vlTOPp->dma_r_payload_resp),2);
        vcdp->fullBit(c+2281,(vlTOPp->dma_r_payload_last));
        vcdp->fullBit(c+2289,(vlTOPp->m2s_data_stream_valid));
        vcdp->fullBit(c+2297,(vlTOPp->m2s_data_stream_ready));
        vcdp->fullBus(c+2305,(vlTOPp->m2s_data_stream_payload_data),32);
        vcdp->fullBus(c+2313,(vlTOPp->m2s_data_stream_payload_id),4);
        vcdp->fullBus(c+2321,(vlTOPp->m2s_data_stream_payload_strb),4);
        vcdp->fullBus(c+2329,(vlTOPp->m2s_data_stream_payload_keep_),4);
        vcdp->fullBit(c+2337,(vlTOPp->m2s_data_stream_payload_last));
        vcdp->fullBus(c+2345,(vlTOPp->m2s_state),2);
        vcdp->fullBit(c+2353,(vlTOPp->m2s_cch_valid));
        vcdp->fullBit(c+2361,(vlTOPp->m2s_cch_ready));
        vcdp->fullBus(c+2369,(vlTOPp->m2s_cch_payload_desc_start_addr),32);
        vcdp->fullBus(c+2377,(vlTOPp->m2s_cch_payload_desc_total_bytes),30);
        vcdp->fullBus(c+2385,(vlTOPp->m2s_cch_payload_desc_burst),2);
        vcdp->fullBus(c+2393,(vlTOPp->m2s_cch_payload_desc_id),4);
        vcdp->fullBit(c+2401,(vlTOPp->m2s_cch_payload_desc_reset));
        vcdp->fullBit(c+2409,(vlTOPp->m2s_intr));
        vcdp->fullBit(c+2417,(vlTOPp->clk));
        vcdp->fullBit(c+2425,(vlTOPp->reset));
        vcdp->fullBit(c+2433,(((IData)(vlTOPp->dma_ar_ready) 
                               & (8U > (IData)(vlTOPp->BDMAm2s__DOT__len_pending_fifo_io_occupancy)))));
        vcdp->fullBit(c+2441,(((IData)(vlTOPp->m2s_cch_payload_desc_reset) 
                               & (IData)(vlTOPp->BDMAm2s__DOT__cycle_finished))));
        vcdp->fullBit(c+2449,(((IData)(vlTOPp->dma_ar_valid) 
                               & (IData)(vlTOPp->dma_ar_ready))));
        vcdp->fullBit(c+2457,(((IData)(vlTOPp->BDMAm2s__DOT__m2s_data_fifo_io_pop_valid) 
                               & (IData)(vlTOPp->m2s_data_stream_ready))));
        vcdp->fullBit(c+2465,(((IData)((vlTOPp->BDMAm2s__DOT__m2s_data_fifo__DOT___zz_logic_ram_port0 
                                        >> 0x2cU)) 
                               & ((IData)(vlTOPp->BDMAm2s__DOT__m2s_data_fifo_io_pop_valid) 
                                  & (IData)(vlTOPp->m2s_data_stream_ready)))));
        vcdp->fullQuad(c+2473,(((0U == (IData)(vlTOPp->m2s_state))
                                 ? VL_ULL(0x49444c45202020)
                                 : ((1U == (IData)(vlTOPp->m2s_state))
                                     ...
                                     : ((2U == (IData)(vlTOPp->m2s_state))
                                         ? VL_ULL(0x46494e414c5f31)
                                         : VL_ULL(0x3f3f3f3f3f3f3f))))),56);
        vcdp->fullBus(c+2489,(0xfU),4);
        vcdp->fullBus(c+2497,(vlTOPp->BDMAm2s__DOT__m2s_axis_low_bytes),2);
        vcdp->fullBus(c+2505,(2U),3);
        vcdp->fullBit(c+2513,(0U));
    }
}
