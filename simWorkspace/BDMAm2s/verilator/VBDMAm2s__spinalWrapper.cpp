...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.dma_ar_valid );
      signalAccess[1] = new CDataSignalAccess( top.dma_ar_ready );
      signalAccess[2] = new IDataSignalAccess( top.dma_ar_payload_addr );
      signalAccess[3] = new CDataSignalAccess( top.dma_ar_payload_id );
      signalAccess[4] = new CDataSignalAccess( top.dma_ar_payload_len );
      signalAccess[5] = new CDataSignalAccess( top.dma_ar_payload_size );
      signalAccess[6] = new CDataSignalAccess( top.dma_ar_payload_burst );
      signalAccess[7] = new CDataSignalAccess( top.dma_r_valid );
      signalAccess[8] = new CDataSignalAccess( top.dma_r_ready );
      signalAccess[9] = new IDataSignalAccess( top.dma_r_payload_data );
      signalAccess[10] = new CDataSignalAccess( top.dma_r_payload_id );
      signalAccess[11] = new CDataSignalAccess( top.dma_r_payload_resp );
      signalAccess[12] = new CDataSignalAccess( top.dma_r_payload_last );
      signalAccess[13] = new CDataSignalAccess( top.m2s_data_stream_valid );
      signalAccess[14] = new CDataSignalAccess( top.m2s_data_stream_ready );
      signalAccess[15] = new IDataSignalAccess( top.m2s_data_stream_payload_data );
      signalAccess[16] = new CDataSignalAccess( top.m2s_data_stream_payload_id );
