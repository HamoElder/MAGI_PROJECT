...
void VBDMAm2s::_ctor_var_reset() {
    ...
    BDMAm2s__DOT__m2s_r_payload = VL_RAND_RESET_I(32);
    BDMAm2s__DOT__m2s_r_residual_payload = VL_RAND_RESET_I(32);
    BDMAm2s__DOT__m2s_r_req = VL_RAND_RESET_I(1);
    BDMAm2s__DOT__m2s_r_first = VL_RAND_RESET_I(1);
    BDMAm2s__DOT__m2s_r_len = VL_RAND_RESET_I(8);
    BDMAm2s__DOT__m2s_r_last_cycle = VL_RAND_RESET_I(1);
    ...
    BDMAm2s__DOT__when_BDMAm2s_l264 = VL_RAND_RESET_I(1);
    BDMAm2s__DOT__dma_r_fire = VL_RAND_RESET_I(1);
    BDMAm2s__DOT__when_BDMAm2s_l307 = VL_RAND_RESET_I(1);
    ...
    __Vdly__BDMAm2s__DOT__m2s_r_req = VL_RAND_RESET_I(1);
    __Vdly__BDMAm2s__DOT__m2s_r_first = VL_RAND_RESET_I(1);
    __Vdly__BDMAm2s__DOT__m2s_r_last_cycle = VL_RAND_RESET_I(1);
