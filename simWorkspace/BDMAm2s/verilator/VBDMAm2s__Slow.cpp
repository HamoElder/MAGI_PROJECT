...
void VBDMAm2s::_settle__TOP__8(VBDMAm2s__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBDMAm2s::_settle__TOP__8\n"); );
    VBDMAm2s* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void VBDMAm2s::_initial__TOP__10(VBDMAm2s__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VBDMAm2s::_initial__TOP__10\n"); );
    VBDMAm2s* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void VBDMAm2s::_ctor_var_reset() {
    ...
    BDMAm2s__DOT___zz_when_BDMAm2s_l96 = VL_RAND_RESET_I(32);
    BDMAm2s__DOT___zz_when_BDMAm2s_l131_1 = VL_RAND_RESET_I(32);
    ...
    BDMAm2s__DOT__when_BDMAm2s_l80 = VL_RAND_RESET_I(1);
