...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.axi4_arvalid );
      signalAccess[1] = new CDataSignalAccess( top.axi4_arready );
      signalAccess[2] = new SDataSignalAccess( top.axi4_araddr );
      signalAccess[3] = new CDataSignalAccess( top.axi4_arid );
      signalAccess[4] = new CDataSignalAccess( top.axi4_arlen );
      signalAccess[5] = new CDataSignalAccess( top.axi4_arsize );
      signalAccess[6] = new CDataSignalAccess( top.axi4_arburst );
      signalAccess[7] = new CDataSignalAccess( top.axi4_awvalid );
      signalAccess[8] = new CDataSignalAccess( top.axi4_awready );
      signalAccess[9] = new SDataSignalAccess( top.axi4_awaddr );
      signalAccess[10] = new CDataSignalAccess( top.axi4_awid );
      signalAccess[11] = new CDataSignalAccess( top.axi4_awlen );
      signalAccess[12] = new CDataSignalAccess( top.axi4_awsize );
      signalAccess[13] = new CDataSignalAccess( top.axi4_awburst );
      signalAccess[14] = new CDataSignalAccess( top.axi4_wvalid );
      signalAccess[15] = new CDataSignalAccess( top.axi4_wready );
      signalAccess[16] = new IDataSignalAccess( top.axi4_wdata );
      signalAccess[17] = new CDataSignalAccess( top.axi4_wstrb );
      signalAccess[18] = new CDataSignalAccess( top.axi4_wlast );
      signalAccess[19] = new CDataSignalAccess( top.axi4_rvalid );
      signalAccess[20] = new CDataSignalAccess( top.axi4_rready );
      signalAccess[21] = new IDataSignalAccess( top.axi4_rdata );
      signalAccess[22] = new CDataSignalAccess( top.axi4_rid );
      signalAccess[23] = new CDataSignalAccess( top.axi4_rresp );
      signalAccess[24] = new CDataSignalAccess( top.axi4_rlast );
      signalAccess[25] = new CDataSignalAccess( top.axi4_bvalid );
      signalAccess[26] = new CDataSignalAccess( top.axi4_bready );
      signalAccess[27] = new CDataSignalAccess( top.axi4_bid );
      signalAccess[28] = new CDataSignalAccess( top.axi4_bresp );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/Axi4Ram/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/Axi4Ram/") + name + ".dat").c_str());
      #endif
    }
