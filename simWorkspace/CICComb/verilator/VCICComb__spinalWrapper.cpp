...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[1] = new IDataSignalAccess( top.raw_data_payload );
      signalAccess[2] = new CDataSignalAccess( top.result_data_valid );
      signalAccess[3] = new IDataSignalAccess( top.result_data_payload );
