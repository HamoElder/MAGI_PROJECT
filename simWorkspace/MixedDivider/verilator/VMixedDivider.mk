...
#    make -f VMixedDivider.mk

default: VMixedDivider
...
VM_PREFIX = VMixedDivider
# Module prefix (from --prefix)
VM_MODPREFIX = VMixedDivider
...
include VMixedDivider_classes.mk
...
VMixedDivider__spinalWrapper.o: verilator/VMixedDivider__spinalWrapper.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
VMixedDivider: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
