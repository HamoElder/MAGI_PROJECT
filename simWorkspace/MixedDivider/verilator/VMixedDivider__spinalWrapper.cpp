...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.flush );
      signalAccess[1] = new CDataSignalAccess( top.cmd_valid );
      signalAccess[2] = new CDataSignalAccess( top.cmd_ready );
      signalAccess[3] = new SDataSignalAccess( top.cmd_payload_numerator );
      signalAccess[4] = new SDataSignalAccess( top.cmd_payload_denominator );
      signalAccess[5] = new CDataSignalAccess( top.cmd_payload_signed );
      signalAccess[6] = new CDataSignalAccess( top.rsp_valid );
      signalAccess[7] = new CDataSignalAccess( top.rsp_ready );
      signalAccess[8] = new SDataSignalAccess( top.rsp_payload_quotient );
      signalAccess[9] = new SDataSignalAccess( top.rsp_payload_remainder );
      signalAccess[10] = new CDataSignalAccess( top.rsp_payload_error );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/crystal/project/MAGI_PROJECT/./simWorkspace/MixedDivider/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/crystal/project/MAGI_PROJECT/./simWorkspace/MixedDivider/") + name + ".dat").c_str());
      #endif
    }
