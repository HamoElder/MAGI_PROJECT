...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[19] = new CDataSignalAccess( top.raw_data_tvalid );
      signalAccess[20] = new CDataSignalAccess( top.raw_data_tready );
      signalAccess[21] = new IDataSignalAccess( top.raw_data_tdata );
      signalAccess[22] = new CDataSignalAccess( top.raw_data_tstrb );
      signalAccess[23] = new CDataSignalAccess( top.raw_data_tkeep );
      signalAccess[24] = new CDataSignalAccess( top.raw_data_tlast );
      signalAccess[25] = new CDataSignalAccess( top.coded_data_valid );
      signalAccess[26] = new CDataSignalAccess( top.coded_data_ready );
      signalAccess[27] = new CDataSignalAccess( top.coded_data_payload_last );
      signalAccess[28] = new SDataSignalAccess( top.coded_data_payload_fragment );
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/TX/") + name + ".dat").c_str());
      #endif
    }
