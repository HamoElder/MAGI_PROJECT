...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[1] = new SDataSignalAccess( top.raw_data_payload );
      signalAccess[2] = new CDataSignalAccess( top.filtered_data_valid );
      signalAccess[3] = new IDataSignalAccess( top.filtered_data_payload );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/CICFilter/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/CICFilter/") + name + ".dat").c_str());
      #endif
    }
