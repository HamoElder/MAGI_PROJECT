...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.base_iq_0_valid );
      signalAccess[1] = new SDataSignalAccess( top.base_iq_0_payload_cha_i );
      signalAccess[2] = new SDataSignalAccess( top.base_iq_0_payload_cha_q );
      signalAccess[3] = new CDataSignalAccess( top.carries_iq_valid );
      signalAccess[4] = new SDataSignalAccess( top.carries_iq_payload_cha_i );
      signalAccess[5] = new SDataSignalAccess( top.carries_iq_payload_cha_q );
      signalAccess[6] = new CDataSignalAccess( top.if_iq_0_valid );
      signalAccess[7] = new IDataSignalAccess( top.if_iq_0_payload );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/IQMixer/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/IQMixer/") + name + ".dat").c_str());
      #endif
    }
