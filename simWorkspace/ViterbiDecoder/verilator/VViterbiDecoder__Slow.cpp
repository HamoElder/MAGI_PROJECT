...
void VViterbiDecoder::_ctor_var_reset() {
    ...
    ViterbiDecoder__DOT__tbu_core__DOT___zz_ram_addr_read = VL_RAND_RESET_I(6);
    ...
    ViterbiDecoder__DOT__tbu_core__DOT__when_Traceback_l115 = VL_RAND_RESET_I(1);
    ViterbiDecoder__DOT__tbu_core__DOT__when_Traceback_l142 = VL_RAND_RESET_I(1);
    ...
    __Vdly__ViterbiDecoder__DOT__tbu_core__DOT__goto_tail = VL_RAND_RESET_I(1);
