...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[4] = new CDataSignalAccess( top.decoded_data_valid );
      signalAccess[5] = new CDataSignalAccess( top.decoded_data_payload_last );
      signalAccess[6] = new CDataSignalAccess( top.decoded_data_payload_fragment );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/ViterbiDecoder/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/ViterbiDecoder/") + name + ".dat").c_str());
      #endif
    }
