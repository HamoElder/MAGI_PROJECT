...
VL_MODULE(VTX) {
  public:
    ...
    struct {
        ...
        CData/*1:0*/ TX__DOT__rate_match__DOT__bits_sel;
        CData/*0:0*/ TX__DOT__rate_match__DOT__raw_data_fire;
        CData/*0:0*/ TX__DOT__rate_match__DOT__result_data_fire;
        CData/*0:0*/ TX__DOT__rate_match__DOT__when_PhyTX_l796;
        CData/*0:0*/ TX__DOT__rate_match__DOT__when_PhyTX_l806;
    ...
    struct {
        ...
        IData/*31:0*/ TX__DOT__rate_match__DOT__vector_length_limit;
    ...
    struct {
        ...
        CData/*1:0*/ __Vdly__TX__DOT__rate_match__DOT__bits_sel;
  ...
  public:
    ...
    static void _initial__TOP__18(VTX__Syms* __restrict vlSymsp) VL_ATTR_COLD;
