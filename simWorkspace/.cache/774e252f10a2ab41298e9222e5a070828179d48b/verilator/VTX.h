...
VL_MODULE(VTX) {
  public:
    ...
    struct {
        ...
        CData/*3:0*/ TX__DOT__rate_match__DOT__result_buf;
        CData/*0:0*/ TX__DOT__rate_match__DOT__cnt_willIncrement;
        CData/*0:0*/ TX__DOT__rate_match__DOT__cnt_willClear;
        CData/*3:0*/ TX__DOT__rate_match__DOT__cnt_valueNext;
        CData/*3:0*/ TX__DOT__rate_match__DOT__cnt_value;
        CData/*0:0*/ TX__DOT__rate_match__DOT__raw_data_fire;
        CData/*0:0*/ TX__DOT__rate_match__DOT__result_data_fire;
        CData/*0:0*/ TX__DOT__rate_match__DOT__when_PhyTX_l808;
        CData/*0:0*/ TX__DOT__rate_match__DOT___zz_result_data_valid;
