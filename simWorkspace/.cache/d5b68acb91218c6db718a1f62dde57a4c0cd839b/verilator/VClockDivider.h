...
VL_MODULE(VClockDivider) {
  public:
    ...
    CData/*2:0*/ ClockDivider__DOT___zz___05Fzz_clk_out;
    CData/*7:0*/ ClockDivider__DOT___zz___05Fzz_when_ClockDivider_l103;
    CData/*2:0*/ ClockDivider__DOT___zz_clk_out;
    CData/*7:0*/ ClockDivider__DOT___zz_when_ClockDivider_l103;
    CData/*0:0*/ ClockDivider__DOT__when_ClockDivider_l103;
