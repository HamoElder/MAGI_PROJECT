...
VL_MODULE(VTX) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ TX__DOT__channel_code__DOT__tailed_conv_encoder__DOT__when_PhyTX_l660;
    ...
    struct {
        ...
        CData/*0:0*/ TX__DOT__channel_code__DOT__tailed_conv_encoder2__DOT__when_PhyTX_l660;
        ...
        CData/*1:0*/ TX__DOT__channel_code__DOT__tailed_conv_encoder2__DOT__data_fifo__DOT___zz_logic_ram_port0;
        ...
        CData/*3:0*/ TX__DOT__rate_match__DOT___zz_interleaving_ram_port2;
        ...
        CData/*0:0*/ TX__DOT__rate_match__DOT__mode;
        CData/*0:0*/ TX__DOT__rate_match__DOT__when_PhyTX_l781;
        CData/*0:0*/ TX__DOT__rate_match__DOT__raw_data_fire_1;
        ...
        SData/*12:0*/ TX__DOT__channel_code__DOT__message_coded_length;
    ...
    struct {
        ...
        CData/*1:0*/ TX__DOT__channel_code__DOT__tailed_conv_encoder2__DOT__data_fifo__DOT__logic_ram[6145];
    ...
    struct {
        ...
        CData/*1:0*/ TX__DOT__channel_code__DOT__tailed_conv_encoder2__DOT__data_fifo__DOT____Vxrand1;
        CData/*1:0*/ TX__DOT__channel_code__DOT__tailed_conv_encoder2__DOT__data_fifo__DOT____Vlvbound2;
        CData/*3:0*/ TX__DOT__rate_match__DOT____Vxrand3;
        CData/*3:0*/ TX__DOT__rate_match__DOT____Vlvbound1;
        ...
        CData/*1:0*/ __Vdlyvval__TX__DOT__channel_code__DOT__tailed_conv_encoder2__DOT__data_fifo__DOT__logic_ram__v0;
        ...
        SData/*12:0*/ __Vdly__TX__DOT__rate_match__DOT__read_addr;
  ...
  public:
    ...
    static void _settle__TOP__1(VTX__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _settle__TOP__2(VTX__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _settle__TOP__3(VTX__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _settle__TOP__4(VTX__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _settle__TOP__5(VTX__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    ...
    static void traceChgThis__26(VTX__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
    ...
    static void traceFullThis__27(VTX__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) VL_ATTR_COLD;
