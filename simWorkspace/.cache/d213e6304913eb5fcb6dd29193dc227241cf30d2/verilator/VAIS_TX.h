...
VL_MODULE(VAIS_TX) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ AIS_TX__DOT__crc16_adder__DOT__when_PhyTx_l77;
        CData/*0:0*/ AIS_TX__DOT__end_flag_adder__DOT__last_flag;
        CData/*0:0*/ AIS_TX__DOT__end_flag_adder__DOT__when_PhyTx_l103_1;
        ...
        CData/*0:0*/ AIS_TX__DOT__preamble_adder__DOT__when_PhyTx_l35;
    ...
    CData/*1:0*/ __Vdly__AIS_TX__DOT__preamble_adder__DOT__cnt;
    CData/*1:0*/ __Vdly__AIS_TX__DOT__preamble_adder__DOT__preamble_status;
  ...
  public:
    static void _combo__TOP__8(VAIS_TX__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _sequent__TOP__3(VAIS_TX__Syms* __restrict vlSymsp);
    static void _sequent__TOP__4(VAIS_TX__Syms* __restrict vlSymsp);
    static void _sequent__TOP__7(VAIS_TX__Syms* __restrict vlSymsp);
    static void _sequent__TOP__9(VAIS_TX__Syms* __restrict vlSymsp);
    static void _settle__TOP__5(VAIS_TX__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _settle__TOP__6(VAIS_TX__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    ...
    static void traceChgThis__8(VAIS_TX__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
    ...
    static void traceFullThis__11(VAIS_TX__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) VL_ATTR_COLD;
