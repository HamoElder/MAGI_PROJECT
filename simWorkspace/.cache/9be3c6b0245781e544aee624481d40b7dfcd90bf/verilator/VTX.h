...
VL_MODULE(VTX) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ TX__DOT__channel_code__DOT__channel_code_msg_fifo_io_pop_fire;
  ...
  public:
    ...
    static void traceFullThis__24(VTX__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) VL_ATTR_COLD;
