...
VL_MODULE(VTX) {
  public:
    ...
    struct {
        ...
        CData/*1:0*/ TX__DOT__code_block_segment__DOT__shared_channel_segment__DOT__calc_step_cnt;
        ...
        CData/*0:0*/ TX__DOT__code_block_segment__DOT__shared_channel_segment__DOT__when_PhyTX_l444;
        CData/*0:0*/ TX__DOT__code_block_segment__DOT__shared_channel_segment__DOT__when_PhyTX_l459;
        CData/*0:0*/ TX__DOT__code_block_segment__DOT__shared_channel_segment__DOT__segment_msg_fire;
        CData/*0:0*/ TX__DOT__code_block_segment__DOT__shared_channel_segment__DOT__when_PhyTX_l494;
    ...
    struct {
        ...
        IData/*20:0*/ TX__DOT__code_block_segment__DOT__shared_channel_segment__DOT___zz_Cn;
        IData/*20:0*/ TX__DOT__code_block_segment__DOT__shared_channel_segment__DOT___zz_F;
        IData/*20:0*/ TX__DOT__code_block_segment__DOT__shared_channel_segment__DOT___zz_zero_padding_cnt_1;
        IData/*19:0*/ TX__DOT__code_block_segment__DOT__shared_channel_segment__DOT__B_full;
    ...
    CData/*1:0*/ __Vdly__TX__DOT__code_block_segment__DOT__shared_channel_segment__DOT__calc_step_cnt;
    ...
    SData/*12:0*/ __Vdly__TX__DOT__code_block_segment__DOT__shared_channel_segment__DOT__Kp;
    SData/*12:0*/ __Vdly__TX__DOT__code_block_segment__DOT__shared_channel_segment__DOT__Kn;
  ...
  public:
    static void _combo__TOP__14(VTX__Syms* __restrict vlSymsp);
    static void _combo__TOP__16(VTX__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _settle__TOP__9(VTX__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    ...
    static void traceFullThis__22(VTX__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) VL_ATTR_COLD;
