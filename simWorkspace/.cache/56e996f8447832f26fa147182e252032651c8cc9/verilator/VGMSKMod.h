...
VL_MODULE(VGMSKMod) {
  public:
    ...
    SData/*9:0*/ GMSKMod__DOT___zz_phi_integral;
    SData/*9:0*/ GMSKMod__DOT__phi_integral;
    SData/*9:0*/ GMSKMod__DOT__symbol_filter__DOT__filtered_data;
    SData/*15:0*/ GMSKMod__DOT__cosTable[9];
    SData/*15:0*/ GMSKMod__DOT__sinTable[9];
    
    // LOCAL VARIABLES
    // Internals; generally not touched by application code
    CData/*0:0*/ __Vclklast__TOP__clk;
    CData/*0:0*/ __Vclklast__TOP__reset;
    SData/*15:0*/ GMSKMod__DOT____Vxrand2;
    SData/*15:0*/ GMSKMod__DOT____Vxrand1;
  ...
  public:
    ...
    static void _initial__TOP__1(VGMSKMod__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _sequent__TOP__2(VGMSKMod__Syms* __restrict vlSymsp);
    static void _settle__TOP__3(VGMSKMod__Syms* __restrict vlSymsp) VL_ATTR_COLD;
  private:
