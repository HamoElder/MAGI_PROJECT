...
VL_MODULE(VTX) {
  public:
    ...
    struct {
        ...
        SData/*8:0*/ TX__DOT__channel_code__DOT__tailed_conv_encoder__DOT___zz_tail_bits;
        ...
        SData/*8:0*/ TX__DOT__channel_code__DOT__tailed_conv_encoder2__DOT___zz_tail_bits;
