...
VL_MODULE(VTX) {
  public:
    ...
    struct {
        ...
        CData/*5:0*/ TX__DOT__stf_preamble_adder__DOT___zz_cnt;
        CData/*5:0*/ TX__DOT__stf_preamble_adder__DOT__cnt;
        CData/*3:0*/ TX__DOT__stf_preamble_adder__DOT__repeatCnt;
    ...
    struct {
        ...
        SData/*11:0*/ TX__DOT__stf_preamble_adder__DOT__I_mem[32];
        SData/*11:0*/ TX__DOT__stf_preamble_adder__DOT__Q_mem[32];
    ...
    CData/*5:0*/ __Vdly__TX__DOT__stf_preamble_adder__DOT__cnt;
    CData/*3:0*/ __Vdly__TX__DOT__stf_preamble_adder__DOT__repeatCnt;
  ...
  public:
    static void _combo__TOP__25(VTX__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _sequent__TOP__24(VTX__Syms* __restrict vlSymsp);
    ...
    static void traceFullThis__14(VTX__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) VL_ATTR_COLD;
