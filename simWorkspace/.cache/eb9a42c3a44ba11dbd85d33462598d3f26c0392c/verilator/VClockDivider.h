...
VL_MODULE(VClockDivider) {
  public:
    ...
    CData/*3:0*/ ClockDivider__DOT___zz___05Fzz_when_ClockDivider_l41;
    CData/*3:0*/ ClockDivider__DOT___zz___05Fzz_when_ClockDivider_l50;
    CData/*0:0*/ ClockDivider__DOT___zz_clk_out;
    CData/*3:0*/ ClockDivider__DOT___zz_when_ClockDivider_l41;
    CData/*0:0*/ ClockDivider__DOT___zz_clk_out_1;
    CData/*3:0*/ ClockDivider__DOT___zz_when_ClockDivider_l50;
  ...
  public:
    ...
    static void _multiclk__TOP__4(VClockDivider__Syms* __restrict vlSymsp);
    static void _sequent__TOP__1(VClockDivider__Syms* __restrict vlSymsp);
    static void _sequent__TOP__2(VClockDivider__Syms* __restrict vlSymsp);
    static void _settle__TOP__3(VClockDivider__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    ...
    static void traceChgThis__4(VClockDivider__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
