...
VL_MODULE(VTX) {
  public:
    ...
    struct {
        ...
        CData/*4:0*/ TX__DOT__rate_match__DOT__pattern_cursor;
        CData/*0:0*/ TX__DOT__rate_match__DOT__raw_data_fire;
        CData/*0:0*/ TX__DOT__rate_match__DOT__result_data_fire;
        CData/*0:0*/ TX__DOT__rate_match__DOT__when_PhyTX_l791;
        CData/*0:0*/ TX__DOT__rate_match__DOT___zz_result_data_payload_last;
    ...
    struct {
        ...
        CData/*4:0*/ __Vdly__TX__DOT__rate_match__DOT__pattern_cursor;
  ...
  public:
    static void _combo__TOP__20(VTX__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _initial__TOP__13(VTX__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    ...
    static void _sequent__TOP__22(VTX__Syms* __restrict vlSymsp);
    ...
    static void _settle__TOP__17(VTX__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    static void _settle__TOP__18(VTX__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    ...
    static void traceFullThis__28(VTX__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) VL_ATTR_COLD;
