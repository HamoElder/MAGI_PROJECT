...
VL_MODULE(VTX) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ TX__DOT__code_block_segment__DOT__shared_channel_segment__DOT__shared_channel_segment_unsigned_divider_cmd_fire_1;
        ...
        CData/*0:0*/ TX__DOT__code_block_segment__DOT__shared_channel_segment__DOT__when_PhyTX_l490;
