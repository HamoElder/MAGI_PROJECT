...
VL_MODULE(VTX) {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ TX__DOT__channel_code__DOT__channel_code_data_fifo_io_pop_thrown_valid;
        ...
        CData/*0:0*/ TX__DOT__channel_code__DOT__tailed_conv_encoder__DOT__when_PhyTX_l658;
    ...
    struct {
        ...
        CData/*0:0*/ TX__DOT__channel_code__DOT__tailed_conv_encoder2__DOT__when_PhyTX_l658;
  ...
  public:
    static void _combo__TOP__19(VTX__Syms* __restrict vlSymsp);
  private:
  ...
  public:
    ...
    static void _initial__TOP__17(VTX__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    ...
    static void _sequent__TOP__21(VTX__Syms* __restrict vlSymsp);
