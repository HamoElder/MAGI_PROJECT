...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.init_state_valid );
      signalAccess[1] = new CDataSignalAccess( top.init_state_payload );
      signalAccess[2] = new CDataSignalAccess( top.scram_data_valid );
      signalAccess[3] = new CDataSignalAccess( top.scram_data_ready );
      signalAccess[4] = new CDataSignalAccess( top.scram_data_payload );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/Scrambler/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/Scrambler/") + name + ".dat").c_str());
      #endif
    }
