...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[1] = new CDataSignalAccess( top.mod_iq_payload_cha_i );
      signalAccess[2] = new CDataSignalAccess( top.mod_iq_payload_cha_q );
      signalAccess[3] = new CDataSignalAccess( top.unit_data_valid );
      signalAccess[4] = new CDataSignalAccess( top.unit_data_payload );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/mPSKMod/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/mPSKMod/") + name + ".dat").c_str());
      #endif
    }
