...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[3] = new CDataSignalAccess( top.raw_data_out_valid );
      signalAccess[4] = new SDataSignalAccess( top.raw_data_out_payload_cha_i );
      signalAccess[5] = new SDataSignalAccess( top.raw_data_out_payload_cha_q );
      signalAccess[6] = new IDataSignalAccess( top.gate_threshold );
      signalAccess[7] = new CDataSignalAccess( top.pkg_detected );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/PreambleDetector/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/PreambleDetector/") + name + ".dat").c_str());
      #endif
    }
