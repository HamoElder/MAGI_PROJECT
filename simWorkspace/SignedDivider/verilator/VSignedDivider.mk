...
#    make -f VSignedDivider.mk

default: VSignedDivider
...
VM_PREFIX = VSignedDivider
# Module prefix (from --prefix)
VM_MODPREFIX = VSignedDivider
...
include VSignedDivider_classes.mk
...
VSignedDivider__spinalWrapper.o: verilator/VSignedDivider__spinalWrapper.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
VSignedDivider: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
