...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.mode );
      signalAccess[1] = new CDataSignalAccess( top.raw_data_iq_valid );
      signalAccess[2] = new CDataSignalAccess( top.raw_data_iq_ready );
      signalAccess[3] = new IDataSignalAccess( top.raw_data_iq_payload_cha_i );
      signalAccess[4] = new IDataSignalAccess( top.raw_data_iq_payload_cha_q );
      signalAccess[5] = new CDataSignalAccess( top.result_iq_valid );
      signalAccess[6] = new CDataSignalAccess( top.result_iq_payload_last );
      signalAccess[7] = new IDataSignalAccess( top.result_iq_payload_fragment_cha_i );
      signalAccess[8] = new IDataSignalAccess( top.result_iq_payload_fragment_cha_q );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/R2MDC_FFT/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/IdeaProjects/MAGI_PROJECT/./simWorkspace/R2MDC_FFT/") + name + ".dat").c_str());
      #endif
    }
