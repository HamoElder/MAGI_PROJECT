...
#    make -f VCDMASpreading.mk

default: VCDMASpreading
...
VM_PREFIX = VCDMASpreading
# Module prefix (from --prefix)
VM_MODPREFIX = VCDMASpreading
...
include VCDMASpreading_classes.mk
...
VCDMASpreading__spinalWrapper.o: verilator/VCDMASpreading__spinalWrapper.cpp
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) $(OPT_FAST) -c -o $@ $<

### Link rules... (from --exe)
VCDMASpreading: $(VK_USER_OBJS) $(VK_GLOBAL_OBJS) $(VM_PREFIX)__ALL.a
