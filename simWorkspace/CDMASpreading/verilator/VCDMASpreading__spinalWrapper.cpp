...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.w_en );
      signalAccess[1] = new CDataSignalAccess( top.w_addr );
      signalAccess[2] = new CDataSignalAccess( top.w_data );
      signalAccess[3] = new CDataSignalAccess( top.clc );
      signalAccess[4] = new CDataSignalAccess( top.cnt_limit );
      signalAccess[5] = new CDataSignalAccess( top.base_iq_valid );
      signalAccess[6] = new CDataSignalAccess( top.base_iq_ready );
      signalAccess[7] = new SDataSignalAccess( top.base_iq_payload_0_cha_i );
      signalAccess[8] = new SDataSignalAccess( top.base_iq_payload_0_cha_q );
      signalAccess[9] = new SDataSignalAccess( top.base_iq_payload_1_cha_i );
      signalAccess[10] = new SDataSignalAccess( top.base_iq_payload_1_cha_q );
      signalAccess[11] = new SDataSignalAccess( top.base_iq_payload_2_cha_i );
      signalAccess[12] = new SDataSignalAccess( top.base_iq_payload_2_cha_q );
      signalAccess[13] = new SDataSignalAccess( top.base_iq_payload_3_cha_i );
      signalAccess[14] = new SDataSignalAccess( top.base_iq_payload_3_cha_q );
      signalAccess[15] = new SDataSignalAccess( top.base_iq_payload_4_cha_i );
      signalAccess[16] = new SDataSignalAccess( top.base_iq_payload_4_cha_q );
      signalAccess[17] = new SDataSignalAccess( top.base_iq_payload_5_cha_i );
      signalAccess[18] = new SDataSignalAccess( top.base_iq_payload_5_cha_q );
      signalAccess[19] = new SDataSignalAccess( top.base_iq_payload_6_cha_i );
      signalAccess[20] = new SDataSignalAccess( top.base_iq_payload_6_cha_q );
      signalAccess[21] = new SDataSignalAccess( top.base_iq_payload_7_cha_i );
      signalAccess[22] = new SDataSignalAccess( top.base_iq_payload_7_cha_q );
      signalAccess[23] = new CDataSignalAccess( top.mod_sub_iqs_0_valid );
      signalAccess[24] = new SDataSignalAccess( top.mod_sub_iqs_0_payload_cha_i );
      signalAccess[25] = new SDataSignalAccess( top.mod_sub_iqs_0_payload_cha_q );
      signalAccess[26] = new CDataSignalAccess( top.mod_sub_iqs_1_valid );
      signalAccess[27] = new SDataSignalAccess( top.mod_sub_iqs_1_payload_cha_i );
      signalAccess[28] = new SDataSignalAccess( top.mod_sub_iqs_1_payload_cha_q );
      signalAccess[29] = new CDataSignalAccess( top.mod_sub_iqs_2_valid );
      signalAccess[30] = new SDataSignalAccess( top.mod_sub_iqs_2_payload_cha_i );
      signalAccess[31] = new SDataSignalAccess( top.mod_sub_iqs_2_payload_cha_q );
      signalAccess[32] = new CDataSignalAccess( top.mod_sub_iqs_3_valid );
      signalAccess[33] = new SDataSignalAccess( top.mod_sub_iqs_3_payload_cha_i );
      signalAccess[34] = new SDataSignalAccess( top.mod_sub_iqs_3_payload_cha_q );
      signalAccess[35] = new CDataSignalAccess( top.mod_sub_iqs_4_valid );
      signalAccess[36] = new SDataSignalAccess( top.mod_sub_iqs_4_payload_cha_i );
      signalAccess[37] = new SDataSignalAccess( top.mod_sub_iqs_4_payload_cha_q );
      signalAccess[38] = new CDataSignalAccess( top.mod_sub_iqs_5_valid );
      signalAccess[39] = new SDataSignalAccess( top.mod_sub_iqs_5_payload_cha_i );
      signalAccess[40] = new SDataSignalAccess( top.mod_sub_iqs_5_payload_cha_q );
      signalAccess[41] = new CDataSignalAccess( top.mod_sub_iqs_6_valid );
      signalAccess[42] = new SDataSignalAccess( top.mod_sub_iqs_6_payload_cha_i );
      signalAccess[43] = new SDataSignalAccess( top.mod_sub_iqs_6_payload_cha_q );
      signalAccess[44] = new CDataSignalAccess( top.mod_sub_iqs_7_valid );
      signalAccess[45] = new SDataSignalAccess( top.mod_sub_iqs_7_payload_cha_i );
      signalAccess[46] = new SDataSignalAccess( top.mod_sub_iqs_7_payload_cha_q );
      signalAccess[47] = new CDataSignalAccess( top.clk );
      signalAccess[48] = new CDataSignalAccess( top.reset );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/crystal/project/MAGI_PROJECT/./simWorkspace/CDMASpreading/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/crystal/project/MAGI_PROJECT/./simWorkspace/CDMASpreading/") + name + ".dat").c_str());
      #endif
    }
