...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[3] = new IDataSignalAccess( top.raw_data_payload_re );
      signalAccess[4] = new IDataSignalAccess( top.raw_data_payload_im );
      signalAccess[5] = new CDataSignalAccess( top.result_valid );
      signalAccess[6] = new CDataSignalAccess( top.result_payload_last );
      signalAccess[7] = new IDataSignalAccess( top.result_payload_fragment_re );
      signalAccess[8] = new IDataSignalAccess( top.result_payload_fragment_im );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/R2MDC/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/R2MDC/") + name + ".dat").c_str());
      #endif
    }
