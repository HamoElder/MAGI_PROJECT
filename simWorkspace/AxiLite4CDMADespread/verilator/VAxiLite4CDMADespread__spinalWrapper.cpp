...
#include "VAxiLite4CDMADespread.h"
#ifdef TRACE
...
public:
    ...
    uint32_t timeCheck;
    bool waveEnabled;
    VAxiLite4CDMADespread top;
    ISignalAccess *signalAccess[51];
    #ifdef TRACE
	  VerilatedVcdC tfp;
	  #endif
    string name;
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[19] = new CDataSignalAccess( top.mod_iq_valid );
      signalAccess[20] = new CDataSignalAccess( top.mod_iq_ready );
      signalAccess[21] = new SDataSignalAccess( top.mod_iq_payload_cha_i );
      signalAccess[22] = new SDataSignalAccess( top.mod_iq_payload_cha_q );
      signalAccess[23] = new CDataSignalAccess( top.base_sub_iqs_0_valid );
      signalAccess[24] = new SDataSignalAccess( top.base_sub_iqs_0_payload_cha_i );
      signalAccess[25] = new SDataSignalAccess( top.base_sub_iqs_0_payload_cha_q );
      signalAccess[26] = new CDataSignalAccess( top.base_sub_iqs_1_valid );
      signalAccess[27] = new SDataSignalAccess( top.base_sub_iqs_1_payload_cha_i );
      signalAccess[28] = new SDataSignalAccess( top.base_sub_iqs_1_payload_cha_q );
      signalAccess[29] = new CDataSignalAccess( top.base_sub_iqs_2_valid );
      signalAccess[30] = new SDataSignalAccess( top.base_sub_iqs_2_payload_cha_i );
      signalAccess[31] = new SDataSignalAccess( top.base_sub_iqs_2_payload_cha_q );
      signalAccess[32] = new CDataSignalAccess( top.base_sub_iqs_3_valid );
      signalAccess[33] = new SDataSignalAccess( top.base_sub_iqs_3_payload_cha_i );
      signalAccess[34] = new SDataSignalAccess( top.base_sub_iqs_3_payload_cha_q );
      signalAccess[35] = new CDataSignalAccess( top.base_sub_iqs_4_valid );
      signalAccess[36] = new SDataSignalAccess( top.base_sub_iqs_4_payload_cha_i );
      signalAccess[37] = new SDataSignalAccess( top.base_sub_iqs_4_payload_cha_q );
      signalAccess[38] = new CDataSignalAccess( top.base_sub_iqs_5_valid );
      signalAccess[39] = new SDataSignalAccess( top.base_sub_iqs_5_payload_cha_i );
      signalAccess[40] = new SDataSignalAccess( top.base_sub_iqs_5_payload_cha_q );
      signalAccess[41] = new CDataSignalAccess( top.base_sub_iqs_6_valid );
      signalAccess[42] = new SDataSignalAccess( top.base_sub_iqs_6_payload_cha_i );
      signalAccess[43] = new SDataSignalAccess( top.base_sub_iqs_6_payload_cha_q );
      signalAccess[44] = new CDataSignalAccess( top.base_sub_iqs_7_valid );
      signalAccess[45] = new SDataSignalAccess( top.base_sub_iqs_7_payload_cha_i );
      signalAccess[46] = new SDataSignalAccess( top.base_sub_iqs_7_payload_cha_q );
      signalAccess[47] = new CDataSignalAccess( top.rf_clk );
      signalAccess[48] = new CDataSignalAccess( top.rf_resetn );
      signalAccess[49] = new CDataSignalAccess( top.clk );
      signalAccess[50] = new CDataSignalAccess( top.reset );

      #ifdef TRACE
      Verilated::traceEverOn(true);
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/crystal/project/MAGI_PROJECT/./simWorkspace/AxiLite4CDMADespread/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/crystal/project/MAGI_PROJECT/./simWorkspace/AxiLite4CDMADespread/") + name + ".dat").c_str());
      #endif
    }
