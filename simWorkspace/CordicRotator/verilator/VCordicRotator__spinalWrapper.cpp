...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[12] = new CDataSignalAccess( top.result_ready );
      signalAccess[13] = new IDataSignalAccess( top.result_payload_x );
      signalAccess[14] = new IDataSignalAccess( top.result_payload_y );
      signalAccess[15] = new IDataSignalAccess( top.result_payload_z );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/CordicRotator/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/CordicRotator/") + name + ".dat").c_str());
      #endif
    }
