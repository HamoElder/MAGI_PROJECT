...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.if_iq_0_valid );
      signalAccess[1] = new SDataSignalAccess( top.if_iq_0_payload );
      signalAccess[2] = new CDataSignalAccess( top.carries_iq_valid );
      signalAccess[3] = new SDataSignalAccess( top.carries_iq_payload_cha_i );
      signalAccess[4] = new SDataSignalAccess( top.carries_iq_payload_cha_q );
      signalAccess[5] = new CDataSignalAccess( top.base_iq_0_valid );
      signalAccess[6] = new SDataSignalAccess( top.base_iq_0_payload_cha_i );
      signalAccess[7] = new SDataSignalAccess( top.base_iq_0_payload_cha_q );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/IQDemixer/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/IQDemixer/") + name + ".dat").c_str());
      #endif
    }
