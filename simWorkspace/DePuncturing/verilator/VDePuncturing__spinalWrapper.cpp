...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.dummy_bits );
      ...
      signalAccess[4] = new SDataSignalAccess( top.raw_data_payload_fragment );
      signalAccess[5] = new CDataSignalAccess( top.de_punched_data_valid );
      signalAccess[6] = new CDataSignalAccess( top.de_punched_data_ready );
      signalAccess[7] = new CDataSignalAccess( top.de_punched_data_payload_last );
      signalAccess[8] = new CDataSignalAccess( top.de_punched_data_payload_fragment );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/DePuncturing/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/DePuncturing/") + name + ".dat").c_str());
      #endif
    }
