...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[7] = new CDataSignalAccess( top.axi4_rvalid );
      signalAccess[8] = new CDataSignalAccess( top.axi4_rready );
      signalAccess[9] = new IDataSignalAccess( top.axi4_rdata );
      signalAccess[10] = new CDataSignalAccess( top.axi4_rid );
      signalAccess[11] = new CDataSignalAccess( top.axi4_rresp );
      signalAccess[12] = new CDataSignalAccess( top.axi4_rlast );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/missdown/MAGI_PROJECT/./simWorkspace/Axi4Rom/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/missdown/MAGI_PROJECT/./simWorkspace/Axi4Rom/") + name + ".dat").c_str());
      #endif
    }
