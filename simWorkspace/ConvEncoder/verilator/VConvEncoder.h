...
VL_MODULE(VConvEncoder) {
  ...
  public:
    ...
    static void _sequent__TOP__1(VConvEncoder__Syms* __restrict vlSymsp);
    static void _sequent__TOP__2(VConvEncoder__Syms* __restrict vlSymsp);
    static void _sequent__TOP__4(VConvEncoder__Syms* __restrict vlSymsp);
    static void _settle__TOP__3(VConvEncoder__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    ...
    static void traceChgThis__6(VConvEncoder__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code);
