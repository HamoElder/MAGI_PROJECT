...
VL_INLINE_OPT void VConvEncoder::_combo__TOP__1(VConvEncoder__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VConvEncoder::_combo__TOP__1\n"); );
    VConvEncoder* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->raw_data_ready = (1U & (~ (IData)(vlTOPp->tail_bits_valid)));
}

VL_INLINE_OPT void VConvEncoder::_sequent__TOP__3(VConvEncoder__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VConvEncoder::_sequent__TOP__3\n"); );
    VConvEncoder* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    ...
    if (vlTOPp->reset) {
        ...
        if ((1U & (~ (IData)(vlTOPp->tail_bits_valid)))) {
            vlTOPp->ConvEncoder__DOT__coded_data_valid_1 
                = vlTOPp->ConvEncoder__DOT__raw_data_fire;
        }
    }
...
VL_INLINE_OPT void VConvEncoder::_sequent__TOP__4(VConvEncoder__Syms* __restrict vlSymsp) {
    ...
    // Body
    if ((1U & (~ (IData)(vlTOPp->tail_bits_valid)))) {
        if (vlTOPp->ConvEncoder__DOT__raw_data_fire) {
...
VL_INLINE_OPT void VConvEncoder::_combo__TOP__5(VConvEncoder__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VConvEncoder::_combo__TOP__5\n"); );
    VConvEncoder* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->ConvEncoder__DOT__raw_data_fire = ((IData)(vlTOPp->raw_data_valid) 
    ...
    vlTOPp->ConvEncoder__DOT___zz_r_enc_2 = ((8U & 
                                             ...
                                             | (7U 
                                                & ((IData)(vlTOPp->ConvEncoder__DOT___zz_r_enc_1) 
                                                   >> 1U)));
    vlTOPp->ConvEncoder__DOT___zz_r_enc_3 = ((8U & (IData)(vlTOPp->raw_data_payload_fragment)) 
                                             | (7U 
