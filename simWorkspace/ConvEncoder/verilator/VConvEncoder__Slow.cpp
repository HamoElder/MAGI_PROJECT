...
void VConvEncoder::_settle__TOP__2(VConvEncoder__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VConvEncoder::_settle__TOP__2\n"); );
    VConvEncoder* __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void VConvEncoder::_ctor_var_reset() {
    ...
    ConvEncoder__DOT__raw_data_fire = VL_RAND_RESET_I(1);
