...
void VConvEncoder::traceInitThis__1(VConvEncoder__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->declBit(c+137,"raw_data_ready", false,-1);
        ...
        vcdp->declBit(c+137,"ConvEncoder raw_data_ready", false,-1);
        ...
        vcdp->declBit(c+81,"ConvEncoder coded_data_valid_1", false,-1);
        ...
        vcdp->declBit(c+73,"ConvEncoder raw_data_fire", false,-1);
        vcdp->declBit(c+89,"ConvEncoder raw_data_payload_last_regNext", false,-1);
    }
}
...
void VConvEncoder::traceFullThis__1(VConvEncoder__Syms* __restrict vlSymsp, VerilatedVcd* vcdp, uint32_t code) {
    ...
    // Body
    {
        ...
        vcdp->fullBit(c+73,(vlTOPp->ConvEncoder__DOT__raw_data_fire));
        vcdp->fullBit(c+81,(vlTOPp->ConvEncoder__DOT__coded_data_valid_1));
        vcdp->fullBit(c+89,(vlTOPp->ConvEncoder__DOT__raw_data_payload_last_regNext));
        ...
        vcdp->fullBit(c+137,(vlTOPp->raw_data_ready));
