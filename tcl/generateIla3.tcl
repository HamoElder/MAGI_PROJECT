...
set_property CONFIG.C_NUM_OF_PROBES 3 [get_ips ila3]
...
set_property CONFIG.C_PROBE0_WIDTH {8} [get_ips ila3]
set_property CONFIG.C_PROBE1_WIDTH {8} [get_ips ila3]
set_property CONFIG.C_PROBE2_WIDTH {8} [get_ips ila3]
