 ...
 *  and which platform-specific headers to includes.  It is then up your (by
 ...
 *  [error](@ref error_handling) occurred.
 *
 *  @errors Possible errors includes @ref GLFW_NO_WINDOW_CONTEXT and @ref
