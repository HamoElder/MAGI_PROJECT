...
case class Correlator(config: CorrelatorConfig) extends Component with complexTrait{
    val io = new Bundle{
    ...
    if(useGauss){
        ...
        val mul_i = RegNext(io.raw_data_0.cha_i * io.raw_data_1.cha_i + io.raw_data_0.cha_q * io.raw_data_1.cha_q) init(0)
        val mul_q = RegNext(io.raw_data_0.cha_q * io.raw_data_1.cha_i - io.raw_data_0.cha_i * io.raw_data_1.cha_q) init(0)
        val mul_data_valid = RegNext(io.raw_data_0.valid && io.raw_data_1.valid) init(False)
